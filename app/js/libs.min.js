!(function (t) {
  ...
  (n = 0),
    ...
    (a.prototype.checkResponsive = function (t, e) {
      ...
      if (
        ("window" === s.respondTo
          ...
          : "slider" === s.respondTo
          ? (n = r)
          : "min" === s.respondTo && (n = Math.min(l, r)),
    ...
    (a.prototype.getSlideCount = function () {
      ...
      return !0 === o.options.swipeToSlide
        ? (o.$slideTrack.find(".slick-slide").each(function (t, e) {
            if (e.offsetLeft - n + c(e).outerWidth() / 2 > -1 * o.swipeLeft)
              return (i = e), !1;
          }),
          ...
          (o.$slides
            ...
            .each(function (t) {
              ...
              c(this).attr({
                ...
                -1 !== i &&
                  ((e = "slick-slide-control" + o.instanceUid + i),
    ...
    (a.prototype.lazyLoad = function () {
      ...
      if (
        (!0 === s.options.centerMode
          ? (i =
              !0 === s.options.infinite
                ? (e = s.currentSlide + (s.options.slidesToShow / 2 + 1)) +
        ...
        for (
          var n = e - 1, a = i, r = s.$slider.find(".slick-slide"), l = 0;
    ...
    (a.prototype.setSlideClasses = function (t) {
      ...
      s.$slides.eq(t).addClass("slick-current"),
        !0 === s.options.centerMode
          ? ((o = s.options.slidesToShow % 2 == 0 ? 1 : 0),
            (n = Math.floor(s.options.slidesToShow / 2)),
            !0 === s.options.infinite &&
              (n <= t && t <= s.slideCount - 1 - n
                ? s.$slides
                    .slice(t - n + o, t + n + 1)
          ...
          : ((i = s.slideCount % s.options.slidesToShow),
            ...
            s.slideCount - t < s.options.slidesToShow
              ? a
                  .slice(e - (s.options.slidesToShow - i), e + i)
                  .addClass("slick-active")
                  .attr("aria-hidden", "false")
              : a
        ...
        !a.options.verticalSwiping && !a.swiping && 4 < s
          ...
          : (!0 === a.options.verticalSwiping &&
            ...
            !1 === a.options.vertical
              ? (a.swipeLeft = e + o * n)
              : (a.swipeLeft = e + o * (a.$list.height() / a.listWidth) * n),
      ...
      for (
        ...
        if (
          ("object" == typeof i || void 0 === i
            ? (e[s].slick = new a(e[s], i))
            : (t = e[s].slick[i].apply(e[s].slick, o)),
          void 0 !== t)
        )
          return t;
      return e;
  ...
  (function (U) {
    ...
    function Y(t, e, i) {
      var o = (i / 100) * (e - t);
      return (
        1 === (o = Math.round(t + o).toString(16)).length && (o = "0" + o), o
      );
    }
    function V(s, h) {
      this.node = s.get(0);
      ...
      var f,
        ...
        y,
        t,
        e = U("<div/>").addClass("jq-ry-group-wrapper").appendTo(s),
        v = U("<div/>")
      ...
      function l(t) {
        ...
        var e = (a = t) / f,
          i = e * m;
        1 < e && (i += (Math.ceil(e) - 1) * y),
          C(h.ratedFill),
          (i = h.rtl ? 100 - i : i) < 0 ? (i = 0) : 100 < i && (i = 100),
          n.css("width", i + "%");
      }
      function c() {
        (t = o * h.numStars + g * (h.numStars - 1)),
          (m = (o / t) * 100),
          (y = (g / t) * 100),
          s.width(t),
          l();
      ...
      function d(t) {
        var e = (h.starWidth = t);
        return (
          (o = window.parseFloat(h.starWidth.replace("px", ""))),
          v.find("svg").attr({ width: h.starWidth, height: e }),
          n.find("svg").attr({ width: h.starWidth, height: e }),
          c(),
          s
        );
      }
      function p(t) {
        return (
          (h.spacing = t),
          (g = parseFloat(h.spacing.replace("px", ""))),
          v.find("svg:not(:first-child)").css({ "margin-left": t }),
          n.find("svg:not(:first-child)").css({ "margin-left": t }),
          c(),
          s
        );
      }
      function u(t) {
        return (
          (h.normalFill = t),
          (h.rtl ? n : v).find("svg").attr({ fill: h.normalFill }),
          s
        );
      }
      var b = h.ratedFill;
      function C(t) {
        ...
        return (
          h.multiColor
            ? ((e = ((a - w) / h.maxValue) * 100),
              (t = (function (t, e, i) {
                if (!t || !e) return null;
                (i = G(i) ? i : 0), (t = X(t)), (e = X(e));
                var o = Y(t.r, e.r, i),
                  n = Y(t.b, e.b, i);
                return "#" + o + Y(t.g, e.g, i) + n;
              })(
                (i = h.multiColor || {}).startColor || W.startColor,
                i.endColor || W.endColor,
                e
              )))
            : (b = t),
          (h.ratedFill = t),
          (h.rtl ? v : n).find("svg").attr({ fill: h.ratedFill }),
          s
        );
      }
      function S(t) {
        (t = !!t), (h.rtl = t), u(h.normalFill), l();
      }
      function x(t) {
        (h.multiColor = t), C(t || b);
      }
      function T(t) {
        (h.numStars = t), (f = h.maxValue / h.numStars), v.empty(), n.empty();
        for (var e = 0; e < h.numStars; e++)
          v.append(U(h.starSvg || _)), n.append(U(h.starSvg || _));
        return d(h.starWidth), u(h.normalFill), p(h.spacing), l(), s;
      }
      function k(t) {
        return (
          (h.maxValue = t),
          (f = h.maxValue / h.numStars),
          h.rating > t && P(t),
          l(),
          s
        );
      ...
      function A(t) {
        return (h.precision = t), P(h.rating), s;
      }
      function O(t) {
        return (h.halfStar = t), s;
      }
      function D(t) {
        return (h.fullStar = t), s;
      }
      function I(t) {
        var e,
          i,
        ...
        return h.rtl && (d = l - d), parseFloat(d);
      }
      function E(t) {
        return (
          (h.readOnly = t),
      ...
      function P(t) {
        ...
        return (
          "string" == typeof e &&
            ("%" === e[e.length - 1] &&
              ((e = e.substr(0, e.length - 1)), k((i = 100))),
            (e = parseFloat(e))),
          (function (t, e, i) {
            if (!(e <= t && t <= i))
              throw Error(
                "Invalid Rating, expected value between " + e + " and " + i
              );
          })(e, w, i),
          ...
          (h.rating = e),
          l(),
          r && s.trigger("rateyo.set", { rating: e }),
          s
        );
      }
      function $(t) {
      ...
      function N(t) {
        return (h.onChange = t), s;
      }
      function M(t) {
        var e = I(t).toFixed(h.precision),
          i = h.maxValue;
        l((e = q(parseFloat(e), w, i))),
          s.trigger("rateyo.change", { rating: e });
      }
      function F() {
        var t, e;
        (e = !1),
          ...
          (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
            ...
            (e = !0),
          e || (l(), s.trigger("rateyo.change", { rating: h.rating }));
      }
      function B(t) {
        var e = I(t).toFixed(h.precision),
          e = parseFloat(e);
      ...
      function L(t, e) {
        h.onInit &&
          "function" == typeof h.onInit &&
          h.onInit.apply(this, [e.rating, i]);
      }
      function j(t, e) {
        h.onChange &&
          "function" == typeof h.onChange &&
          h.onChange.apply(this, [e.rating, i]);
      }
      function H(t, e) {
        h.onSet &&
          "function" == typeof h.onSet &&
          h.onSet.apply(this, [e.rating, i]);
      }
      function z() {
        s.off("mousemove", M)
          .off("mouseenter", M)
      ...
      (this.rating = function (t) {
        return G(t) ? (P(t), s) : h.rating;
      }),
        (this.destroy = function () {
          var o, n;
          return (
            h.readOnly || z(),
            (V.prototype.collection =
              ((o = s.get(0)),
              (n = this.collection),
              U.each(n, function (t) {
                if (o === this.node) {
                  var e = n.slice(0, t),
                    i = n.slice(t + 1, n.length);
                  return (n = e.concat(i)), !1;
                }
              }),
              n)),
            s.removeClass("jq-ry-container").children().remove(),
            s
          );
        }),
        ...
        this.rating(h.rating, !0),
        (r = !0),
        s.trigger("rateyo.init", { rating: h.rating });
    }
    function c(t, e) {
      var i;
      return (
    ...
    (V.prototype.collection = []),
      (window.RateYo = V),
      (U.fn.rateYo = function () {
        return function (i) {
          var s = V.prototype.collection,
            t = U(this);
          ...
          return (
            ...
            U.each(t, function () {
              ...
              var e = U(this),
                ...
                n = U.extend({}, i);
              return (
                U.each(e.data(), function (t, e) {
                  var i;
                  0 === t.indexOf("rateyo") &&
                    ((i =
                      (i = t.replace(/^rateyo/, ""))[0].toLowerCase() +
                      i.slice(1)),
                    (o[i] = e),
                    delete n[i]);
                }),
                new V(U(this), U.extend({}, o, n))
              );
            })
          );
    ...
    !(function () {
      for (
        var t,
          ...
          r,
          e = ["webkit", "moz", "o", "ms"],
          i = u.document.createElement("div"),
          o = -1,
          o = 0;
        o < e.length && !u.requestAnimationFrame;
        o++
      )
        u.requestAnimationFrame = u[e[o] + "RequestAnimationFrame"];
      function l() {}
      void 0 === i.nextElementSibling &&
        Object.defineProperty(u.Element.prototype, "nextElementSibling", {
          get: function () {
        ...
        Object.keys ||
          (Object.keys =
            ...
            function (t) {
              ...
              if (a) for (o = 0; o < r; o++) n.call(t, s[o]) && e.push(s[o]);
              return e;
            })),
        Array.isArray ||
        ...
        Array.prototype.indexOf ||
          (Array.prototype.indexOf = function (t) {
            ...
            if (0 == (n = (o = Object(this)).length >>> 0)) return -1;
            if (
              ((e = 0),
              1 < arguments.length &&
        ...
        u.Element.prototype.dispatchEvent ||
          (u.Element.prototype.dispatchEvent = function (t) {
            try {
      ...
      ((h = function (t, e, i) {
        ...
        if (
          ...
          d = r.querySelectorAll(t);
        else if (t && "object" == typeof t && f.isElement(t, r)) d = [t];
        else {
          if (!t || "object" != typeof t || !t.length)
            throw new Error(h.messages.errorFactoryInvalidContainer());
          d = t;
        }
        if (d.length < 1)
          throw new Error(h.messages.errorFactoryContainerNotFound());
        for (p = 0; (n = d[p]) && (!(0 < p) || s); p++)
          n.id ? (c = n.id) : ((c = "MixItUp" + f.randomHex()), (n.id = c)),
            h.instances[c] instanceof h.Mixer
              ? ((a = h.instances[c]),
                (!e || (e && e.debug && !1 !== e.debug.showWarnings)) &&
                  console.warn(h.messages.warningFactoryPreexistingInstance()))
              : ((a = new h.Mixer()).attach(n, r, c, e), (h.instances[c] = a)),
            (o = new h.Facade(a)),
            e && e.debug && e.debug.enable ? l.push(a) : l.push(o);
        return s ? new h.Collection(l) : l[0];
      }).use = function (t) {
        h.Base.prototype.callActions.call(h, "beforeUse", arguments),
          "function" == typeof t && "mixitup-extension" === t.TYPE
            ? void 0 === h.extensions[t.NAME] &&
              (t(h), (h.extensions[t.NAME] = t))
            : t.fn && t.fn.jquery && (h.libraries.$ = t),
          h.Base.prototype.callActions.call(h, "afterUse", arguments);
      }),
      (h.instances = {}),
      (h.extensions = {}),
      (h.libraries = {}),
      (f = {
        ...
        extend: function (e, t, i, o) {
          ...
          try {
            ...
            for (a = 0; a < s.length; a++)
              (n = s[a]),
                !i || "object" != typeof t[n] || this.isElement(t[n])
                  ? (e[n] = t[n])
                  : (Array.isArray(t[n])
                      ? e[n] || (e[n] = [])
                      : e[n] || (e[n] = {}),
                    this.extend(e[n], t[n], i, o));
          } catch (t) {
            if (!o) throw t;
        ...
        handleExtendError: function (t, e) {
          ...
          if (
            ...
            throw (
              (1 < l &&
                (s = h.messages.errorConfigInvalidPropertySuggestion({
                  probableMatch: a,
                })),
              (i = h.messages.errorConfigInvalidProperty({
                erroneous: n,
                suggestion: s,
              })),
              new TypeError(i))
        ...
        template: function (o) {
          for (var t, e = /\${([\w]*)}/g, n = {}; (t = e.exec(o)); )
            n[t[1]] = new RegExp("\\${" + t[1] + "}", "g");
          return function (t) {
            var e = "",
              i = o;
            for (e in ((t = t || {}), n))
              i = i.replace(n[e], void 0 !== t[e] ? t[e] : "");
            return i;
          };
        },
        on: function (t, e, i, o) {
        ...
        getCustomEvent: function (t, e, i) {
          ...
          return (
            (i = i || u.document),
            "function" == typeof u.CustomEvent
              ? (o = new u.CustomEvent(t, {
                  detail: e,
                  bubbles: !0,
                  cancelable: !0,
                }))
              : "function" == typeof i.createEvent
              ? (o = i.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e)
              : (((o = i.createEventObject()).type = t),
                (o.returnValue = !1),
                (o.cancelBubble = !1),
                (o.detail = e)),
            o
        ...
        createElement: function (t, e) {
          var i = null,
            o = null,
            i = (e = e || u.document).createDocumentFragment();
          for (
        ...
        arrayShuffle: function (t) {
          for (var e, i, o = t.slice(), n = o.length, s = n; s--; )
            (e = ~~(Math.random() * n)), (i = o[s]), (o[s] = o[e]), (o[e] = i);
          return o;
        },
        ...
        debounce: function (n, s, a) {
          ...
          return function () {
            ...
            clearTimeout(r), (r = setTimeout(o, s)), i && n.apply(t, e);
          };
        },
        position: function (t) {
          for (var e = 0, i = 0, o = t; t; )
            (e -= t.scrollLeft),
              (i -= t.scrollTop),
              t === o &&
                ((e += t.offsetLeft), (i += t.offsetTop), (o = t.offsetParent)),
              (t = t.parentElement);
          return { x: e, y: i };
        },
        ...
        closestParent: function (t, e, i, o) {
          var n = t.parentNode;
          if (((o = o || u.document), i && t.matches(e))) return t;
          for (; n && n != o.body; ) {
        ...
        children: function (t, e, i) {
          ...
          return (
            (i = i || u.doc),
            t &&
              (t.id || ((n = "Temp" + this.randomHexKey()), (t.id = n)),
              (o = i.querySelectorAll("#" + t.id + " > " + e)),
              n && t.removeAttribute("id")),
            o
          );
        },
        clean: function (t) {
          for (var e = [], i = -1, i = 0; i < t.length; i++)
            "" !== t[i] && e.push(t[i]);
          return e;
        },
        defer: function (t) {
          var e = null,
            ...
            i = new this.Deferred();
          return (
            h.features.has.promises
              ? (i.promise = new Promise(function (t, e) {
                  (i.resolve = t), (i.reject = e);
                }))
              : (o = u.jQuery || t.$) && "function" == typeof o.Deferred
              ? ((e = o.Deferred()),
                (i.promise = e.promise()),
                (i.resolve = e.resolve),
                (i.reject = e.reject))
              : u.console &&
                console.warn(h.messages.warningNoPromiseImplementation()),
            i
          );
        },
        all: function (t, e) {
          var i = null;
          return h.features.has.promises
            ? Promise.all(t)
            : (i = u.jQuery || e.$) && "function" == typeof i.when
        ...
        getDocumentState: function (t) {
          return (
            (t = "object" == typeof t.body ? t : u.document),
            {
        ...
        isVisible: function (t) {
          ...
          return (
            !!t.offsetParent ||
            ("fixed" === (e = u.getComputedStyle(t)).position &&
              "hidden" !== e.visibility &&
              "0" !== e.opacity)
          );
        },
        ...
        compareVersions: function (t, e) {
          for (
            var i, o, n = t.split("."), s = e.split("."), a = -1, a = 0;
            a < n.length;
            a++
          ) {
            if (
              ((i = parseInt(n[a].replace(/[^\d.]/g, ""))),
              (o = parseInt(s[a].replace(/[^\d.]/g, "") || 0)) < i)
            )
              return !1;
            if (i < o) return !0;
          }
      ...
      (h.Base.prototype = {
        ...
        callFilters: function (t, e, i) {
          var o = this.constructor.filters[t],
            n = e,
            s = "";
          if (!o || f.isEmptyObject(o)) return n;
          for (s in ((i = i || []), o))
            (i = f.arrayFromList(i)).unshift(n), (n = o[s].apply(this, i));
          return n;
        },
      }),
      (h.BaseStatic = function () {
        (this.actions = {}),
          (this.filters = {}),
      ...
      h.BaseStatic.call(h.Features),
      (h.Features.prototype = Object.create(h.Base.prototype)),
      f.extend(h.Features.prototype, {
        constructor: h.Features,
        init: function () {
          var t = this;
        ...
        runTests: function () {
          ...
          t.callActions("beforeRunTests", arguments),
            (t.has.promises = "function" == typeof u.Promise),
        ...
        setPrefixes: function () {
          ...
          t.callActions("beforeSetPrefixes", arguments),
            (t.transitionPrefix = f.getPrefix(
              t.canary,
              "Transition",
              t.VENDORS
            )),
            ...
            (t.boxSizingProp = t.boxSizingPrefix
              ? t.boxSizingPrefix + f.pascalCase(t.BOX_SIZING_PROP)
              : t.BOX_SIZING_PROP),
            (t.transitionProp = t.transitionPrefix
              ? t.transitionPrefix + f.pascalCase(t.TRANSITION_PROP)
              : t.TRANSITION_PROP),
            (t.transformProp = t.transformPrefix
              ? t.transformPrefix + f.pascalCase(t.TRANSFORM_PROP)
              : t.TRANSFORM_PROP),
            (t.transformRule = t.transformPrefix
              ? "-" + t.transformPrefix + "-" + t.TRANSFORM_PROP
              : t.TRANSFORM_PROP),
            (t.perspectiveProp = t.transformPrefix
              ? t.transformPrefix + f.pascalCase(t.PERSPECTIVE_PROP)
              : t.PERSPECTIVE_PROP),
            (t.perspectiveOriginProp = t.transformPrefix
              ? t.transformPrefix + f.pascalCase(t.PERSPECTIVE_ORIGIN_PROP)
      ...
      (h.features = new h.Features()),
      h.features.init(),
      (h.ConfigAnimation = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.enable = !0),
      ...
      h.BaseStatic.call(h.ConfigAnimation),
      (h.ConfigAnimation.prototype = Object.create(h.Base.prototype)),
      (h.ConfigAnimation.prototype.constructor = h.ConfigAnimation),
      (h.ConfigBehavior = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.liveSort = !1),
          this.callActions("afterConstruct"),
      ...
      h.BaseStatic.call(h.ConfigBehavior),
      (h.ConfigBehavior.prototype = Object.create(h.Base.prototype)),
      (h.ConfigBehavior.prototype.constructor = h.ConfigBehavior),
      (h.ConfigCallbacks = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
      ...
      h.BaseStatic.call(h.ConfigCallbacks),
      (h.ConfigCallbacks.prototype = Object.create(h.Base.prototype)),
      (h.ConfigCallbacks.prototype.constructor = h.ConfigCallbacks),
      (h.ConfigControls = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.enable = !0),
          (this.live = !1),
      ...
      h.BaseStatic.call(h.ConfigControls),
      (h.ConfigControls.prototype = Object.create(h.Base.prototype)),
      (h.ConfigControls.prototype.constructor = h.ConfigControls),
      (h.ConfigClassNames = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.block = "mixitup"),
      ...
      h.BaseStatic.call(h.ConfigClassNames),
      (h.ConfigClassNames.prototype = Object.create(h.Base.prototype)),
      (h.ConfigClassNames.prototype.constructor = h.ConfigClassNames),
      (h.ConfigData = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.uidKey = ""),
          (this.dirtyCheck = !1),
      ...
      h.BaseStatic.call(h.ConfigData),
      (h.ConfigData.prototype = Object.create(h.Base.prototype)),
      (h.ConfigData.prototype.constructor = h.ConfigData),
      (h.ConfigDebug = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.enable = !1),
          (this.showWarnings = !0),
      ...
      h.BaseStatic.call(h.ConfigDebug),
      (h.ConfigDebug.prototype = Object.create(h.Base.prototype)),
      (h.ConfigDebug.prototype.constructor = h.ConfigDebug),
      (h.ConfigLayout = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
      ...
      h.BaseStatic.call(h.ConfigLayout),
      (h.ConfigLayout.prototype = Object.create(h.Base.prototype)),
      (h.ConfigLayout.prototype.constructor = h.ConfigLayout),
      (h.ConfigLoad = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.filter = "all"),
      ...
      h.BaseStatic.call(h.ConfigLoad),
      (h.ConfigLoad.prototype = Object.create(h.Base.prototype)),
      (h.ConfigLoad.prototype.constructor = h.ConfigLoad),
      (h.ConfigSelectors = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.target = ".mix"),
          (this.control = ""),
      ...
      h.BaseStatic.call(h.ConfigSelectors),
      (h.ConfigSelectors.prototype = Object.create(h.Base.prototype)),
      (h.ConfigSelectors.prototype.constructor = h.ConfigSelectors),
      (h.ConfigRender = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.target = null),
          this.callActions("afterConstruct"),
      ...
      h.BaseStatic.call(h.ConfigRender),
      (h.ConfigRender.prototype = Object.create(h.Base.prototype)),
      (h.ConfigRender.prototype.constructor = h.ConfigRender),
      (h.ConfigTemplates = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.ConfigTemplates),
      (h.ConfigTemplates.prototype = Object.create(h.Base.prototype)),
      (h.ConfigTemplates.prototype.constructor = h.ConfigTemplates),
      (h.Config = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.animation = new h.ConfigAnimation()),
          (this.behavior = new h.ConfigBehavior()),
          (this.callbacks = new h.ConfigCallbacks()),
          (this.controls = new h.ConfigControls()),
          (this.classNames = new h.ConfigClassNames()),
          (this.data = new h.ConfigData()),
          (this.debug = new h.ConfigDebug()),
          (this.layout = new h.ConfigLayout()),
          (this.load = new h.ConfigLoad()),
          (this.selectors = new h.ConfigSelectors()),
          (this.render = new h.ConfigRender()),
          (this.templates = new h.ConfigTemplates()),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.Config),
      (h.Config.prototype = Object.create(h.Base.prototype)),
      (h.Config.prototype.constructor = h.Config),
      (h.MixerDom = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.document = null),
      ...
      h.BaseStatic.call(h.MixerDom),
      (h.MixerDom.prototype = Object.create(h.Base.prototype)),
      (h.MixerDom.prototype.constructor = h.MixerDom),
      (h.UiClassNames = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.base = ""),
          (this.active = ""),
      ...
      h.BaseStatic.call(h.UiClassNames),
      (h.UiClassNames.prototype = Object.create(h.Base.prototype)),
      (h.UiClassNames.prototype.constructor = h.UiClassNames),
      (h.CommandDataset = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.dataset = null),
          this.callActions("afterConstruct"),
      ...
      h.BaseStatic.call(h.CommandDataset),
      (h.CommandDataset.prototype = Object.create(h.Base.prototype)),
      (h.CommandDataset.prototype.constructor = h.CommandDataset),
      (h.CommandMultimix = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.filter = null),
          (this.sort = null),
      ...
      h.BaseStatic.call(h.CommandMultimix),
      (h.CommandMultimix.prototype = Object.create(h.Base.prototype)),
      (h.CommandMultimix.prototype.constructor = h.CommandMultimix),
      (h.CommandFilter = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.selector = ""),
      ...
      h.BaseStatic.call(h.CommandFilter),
      (h.CommandFilter.prototype = Object.create(h.Base.prototype)),
      (h.CommandFilter.prototype.constructor = h.CommandFilter),
      (h.CommandSort = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.sortString = ""),
          (this.attribute = ""),
      ...
      h.BaseStatic.call(h.CommandSort),
      (h.CommandSort.prototype = Object.create(h.Base.prototype)),
      (h.CommandSort.prototype.constructor = h.CommandSort),
      (h.CommandInsert = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.index = 0),
          (this.collection = []),
      ...
      h.BaseStatic.call(h.CommandInsert),
      (h.CommandInsert.prototype = Object.create(h.Base.prototype)),
      (h.CommandInsert.prototype.constructor = h.CommandInsert),
      (h.CommandRemove = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.targets = []),
          (this.collection = []),
      ...
      h.BaseStatic.call(h.CommandRemove),
      (h.CommandRemove.prototype = Object.create(h.Base.prototype)),
      (h.CommandRemove.prototype.constructor = h.CommandRemove),
      (h.CommandChangeLayout = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.containerClassName = ""),
          this.callActions("afterConstruct"),
      ...
      h.BaseStatic.call(h.CommandChangeLayout),
      (h.CommandChangeLayout.prototype = Object.create(h.Base.prototype)),
      (h.CommandChangeLayout.prototype.constructor = h.CommandChangeLayout),
      (h.ControlDefinition = function (t, e, i, o) {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.type = t),
          (this.selector = e),
      ...
      h.BaseStatic.call(h.ControlDefinition),
      (h.ControlDefinition.prototype = Object.create(h.Base.prototype)),
      (h.ControlDefinition.prototype.constructor = h.ControlDefinition),
      (h.controlDefinitions = []),
      h.controlDefinitions.push(
        new h.ControlDefinition("multimix", "[data-filter][data-sort]")
      ),
      h.controlDefinitions.push(
        new h.ControlDefinition("filter", "[data-filter]")
      ),
      h.controlDefinitions.push(new h.ControlDefinition("sort", "[data-sort]")),
      h.controlDefinitions.push(
        new h.ControlDefinition("toggle", "[data-toggle]")
      ),
      (h.Control = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          ...
          (this.canDisable = !1),
          (this.handler = null),
          (this.classNames = new h.UiClassNames()),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.Control),
      (h.Control.prototype = Object.create(h.Base.prototype)),
      f.extend(h.Control.prototype, {
        constructor: h.Control,
        init: function (t, e, i) {
          var o = this;
          if (
            ...
            switch (
              ((o.canDisable = "boolean" == typeof o.el.disable), o.type)
            ) {
              case "filter":
        ...
        removeBinding: function (t) {
          ...
          this.callActions("beforeRemoveBinding", arguments),
            ...
            e.bound.length < 1 &&
              (e.unbindClick(),
              (i = h.controls.indexOf(e)),
              h.controls.splice(i, 1),
          ...
          if (
            ...
            switch (i.type) {
              ...
              case "multimix":
                ...
                break;
              case "toggle":
                (a.filter = i.filter || o.getAttribute("data-toggle")),
                  (s =
                    "live" === i.status
                      ? f.hasClass(o, i.classNames.active)
                      : "active" === i.status);
            }
            for (l = 0; l < i.bound.length; l++)
              (e = new h.CommandMultimix()), f.extend(e, a), r.push(e);
            for (
              r = i.callFilters("commandsHandleClick", r, arguments),
              ...
              (a = r[l]) &&
                ...
                ("function" == typeof n.config.callbacks.onMixClick &&
                  !1 ===
                    n.config.callbacks.onMixClick.call(
                      n.lastClicked,
                      n.state,
                      t,
                      n
        ...
        updateLive: function (t, e) {
          ...
          if ((o.callActions("beforeUpdateLive", arguments), o.el)) {
            for (
              i = o.el.querySelectorAll(o.selector), a = 0;
              (s = i[a]);
              a++
            ) {
              switch (((n = new h.CommandMultimix()), o.type)) {
                case "filter":
                  n.filter = s.getAttribute("data-filter");
                  break;
                case "sort":
                  n.sort = s.getAttribute("data-sort");
                  break;
                case "multimix":
                  (n.filter = s.getAttribute("data-filter")),
                    (n.sort = s.getAttribute("data-sort"));
                  break;
                case "toggle":
                  n.filter = s.getAttribute("data-toggle");
              }
              (n = o.callFilters("actionsUpdateLive", n, arguments)),
                o.parseStatusChange(s, t, n, e);
            }
        ...
        parseStatusChange: function (t, e, i, o) {
          var n = this,
            ...
            a = -1;
          switch (
            (n.callActions("beforeParseStatusChange", arguments), n.type)
          ) {
            case "filter":
              e.filter === i.filter
            ...
            case "multimix":
              ...
              break;
            case "sort":
              e.sort.match(/:asc/g) && (s = e.sort.replace(/:asc/g, "")),
                e.sort === i.sort || s === i.sort
                  ? n.renderStatus(t, "active")
                  : n.renderStatus(t, "inactive");
              break;
            case "toggle":
              for (
                o.length < 1 && n.renderStatus(t, "inactive"),
                  e.filter === i.filter && n.renderStatus(t, "active"),
                  a = 0;
                a < o.length;
                a++
              ) {
      ...
      (h.StyleData = function () {
        h.Base.call(this),
          ...
          (this.marginBottom = 0),
          (this.opacity = 0),
          (this.scale = new h.TransformData()),
          (this.translateX = new h.TransformData()),
          (this.translateY = new h.TransformData()),
          (this.translateZ = new h.TransformData()),
          (this.rotateX = new h.TransformData()),
          (this.rotateY = new h.TransformData()),
          (this.rotateZ = new h.TransformData()),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.StyleData),
      (h.StyleData.prototype = Object.create(h.Base.prototype)),
      (h.StyleData.prototype.constructor = h.StyleData),
      (h.TransformData = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.value = 0),
          (this.unit = ""),
      ...
      h.BaseStatic.call(h.TransformData),
      (h.TransformData.prototype = Object.create(h.Base.prototype)),
      (h.TransformData.prototype.constructor = h.TransformData),
      (h.TransformDefaults = function () {
        h.StyleData.apply(this),
          this.callActions("beforeConstruct"),
      ...
      h.BaseStatic.call(h.TransformDefaults),
      (h.TransformDefaults.prototype = Object.create(h.StyleData.prototype)),
      (h.TransformDefaults.prototype.constructor = h.TransformDefaults),
      (h.transformDefaults = new h.TransformDefaults()),
      (h.EventDetail = function () {
        (this.state = null),
      ...
      h.BaseStatic.call(h.Events),
      (h.Events.prototype = Object.create(h.Base.prototype)),
      (h.Events.prototype.constructor = h.Events),
      (h.Events.prototype.fire = function (t, e, i, o) {
        var n,
          s = new h.EventDetail();
        if ((this.callActions("beforeFire", arguments), void 0 === this[t]))
          throw new Error('Event type "' + t + '" not found.');
        (s.state = new h.State()),
          f.extend(s.state, i.state),
          i.futureState &&
            ((s.futureState = new h.State()),
            f.extend(s.futureState, i.futureState)),
          (s.instance = i.instance),
          i.originalEvent && (s.originalEvent = i.originalEvent),
          (n = f.getCustomEvent(t, s, o)),
          this.callFilters("eventFire", n, arguments),
          e.dispatchEvent(n);
      }),
      (h.events = new h.Events()),
      (h.QueueItem = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.args = []),
      ...
      h.BaseStatic.call(h.QueueItem),
      (h.QueueItem.prototype = Object.create(h.Base.prototype)),
      (h.QueueItem.prototype.constructor = h.QueueItem),
      (h.Mixer = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.config = new h.Config()),
          (this.id = ""),
          (this.isBusy = !1),
          (this.isToggling = !1),
          (this.incPadding = !0),
          ...
          (this.dom = new h.MixerDom()),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.Mixer),
      (h.Mixer.prototype = Object.create(h.Base.prototype)),
      f.extend(h.Mixer.prototype, {
        constructor: h.Mixer,
        attach: function (t, e, i, o) {
          var n = this,
            ...
            a = -1;
          for (
            n.callActions("beforeAttach", arguments),
              n.id = i,
              o && f.extend(n.config, o, !0, !0),
              n.sanitizeConfig(),
              n.cacheDom(t, e),
              n.config.layout.containerClassName &&
                f.addClass(n.dom.container, n.config.layout.containerClassName),
              h.features.has.transitions || (n.config.animation.enable = !1),
              void 0 === u.console && (n.config.debug.showWarnings = !1),
              n.config.data.uidKey && (n.config.controls.enable = !1),
              n.indexTargets(),
              n.state = n.getInitialState(),
              a = 0;
            (s = n.lastOperation.toHide[a]);
            a++
          )
            s.hide();
          n.config.controls.enable &&
            (n.initControls(),
            n.buildToggleArray(null, n.state),
            n.updateControls({
              filter: n.state.activeFilter,
              sort: n.state.activeSort,
            })),
            n.parseEffects(),
            n.callActions("afterAttach", arguments);
        },
        ...
        getInitialState: function () {
          ...
          if (
            ...
            if (
              ...
              throw new TypeError(h.messages.errorConfigDataUidKeyNotSet());
            ...
            (e.activeFilter = t.parseFilterArgs([
              ...
              "desc" === e.activeSort.order
                ? ((i.newSort = e.activeSort),
                  t.sortOperation(i),
                  t.printSort(!1, i),
                  (t.targets = i.newOrder))
                : (i.startOrder = i.newOrder = t.targets),
              (i.startFilter = i.newFilter = e.activeFilter),
              (i.startSort = i.newSort = e.activeSort),
              (i.startContainerClassName = i.newContainerClassName =
                e.activeContainerClassName),
              "all" === i.newFilter.selector
                ? (i.newFilter.selector = t.config.selectors.target)
                : "none" === i.newFilter.selector &&
                  (i.newFilter.selector = "");
          return (
            (i = t.callFilters("operationGetInitialState", i, [e])),
        ...
        indexTargets: function () {
          var t,
            ...
            n = -1;
          if (
            (i.callActions("beforeIndexTargets", arguments),
            (i.dom.targets = i.config.layout.allowNestedTargets
              ? i.dom.container.querySelectorAll(i.config.selectors.target)
              : f.children(
                  i.dom.container,
                  i.config.selectors.target,
                  i.dom.document
                )),
            (i.dom.targets = f.arrayFromList(i.dom.targets)),
            (i.targets = []),
            (e = i.config.load.dataset) && e.length !== i.dom.targets.length)
          )
            throw new Error(h.messages.errorDatasetPrerenderedMismatch());
          if (i.dom.targets.length) {
            for (n = 0; (t = i.dom.targets[n]); n++)
              (o = new h.Target()).init(t, i, e ? e[n] : void 0),
                (o.isInDom = !0),
                i.targets.push(o);
            i.dom.parent =
              i.dom.targets[0].parentElement === i.dom.container
                ? i.dom.container
                : i.dom.targets[0].parentElement;
          }
          (i.origOrder = i.targets),
            i.callActions("afterIndexTargets", arguments);
        },
        initControls: function () {
          var t,
            ...
            l = -1;
          switch (
            (i.callActions("beforeInitControls", arguments),
            i.config.controls.scope)
          ) {
            case "local":
              n = i.dom.container;
              break;
            case "global":
              ...
              break;
            default:
              throw new Error(h.messages.errorConfigInvalidControlsScope());
          }
          for (r = 0; (t = h.controlDefinitions[r]); r++)
            if (i.config.controls.live || t.live) {
              if (t.parent) {
                if (!(s = i.dom[t.parent]) || s.length < 0) continue;
                "number" != typeof s.length && (s = [s]);
              } else s = [n];
              for (l = 0; (o = s[l]); l++)
                (a = i.getControl(o, t.type, t.selector)), i.controls.push(a);
            } else
              for (
                e = n.querySelectorAll(i.config.selectors.control + t.selector),
                  l = 0;
                (o = e[l]);
                l++
              )
                (a = i.getControl(o, t.type, "")) && i.controls.push(a);
        ...
        getControl: function (t, e, i) {
          ...
          if ((o.callActions("beforeGetControl", arguments), !i))
            for (s = 0; (n = h.controls[s]); s++) {
              if (n.el === t && n.isBound(o))
                return o.callFilters("controlGetControl", null, arguments);
              if (n.el === t && n.type === e && n.selector === i)
                return (
                  n.addBinding(o),
                  o.callFilters("controlGetControl", n, arguments)
                );
            }
          return (
            (n = new h.Control()).init(t, e, i),
            (n.classNames.base = f.getClassname(o.config.classNames, e)),
            (n.classNames.active = f.getClassname(
              o.config.classNames,
              e,
              o.config.classNames.modifierActive
            )),
            (n.classNames.disabled = f.getClassname(
              o.config.classNames,
              e,
        ...
        getToggleSelector: function () {
          ...
          return (
            ...
            "" === (i = t.toggleArray.join(e)) &&
              (i = t.config.controls.toggleDefault),
        ...
        buildToggleArray: function (t, e) {
          var i = this,
            o = "";
          if (
            (i.callActions("beforeBuildToggleArray", arguments), t && t.filter)
          )
          ...
          (o !== i.config.selectors.target && "all" !== o) || (o = ""),
            "or" === i.config.controls.toggleLogic
              ? (i.toggleArray = o.split(","))
              : (i.toggleArray = i.splitCompoundSelector(o)),
        ...
        splitCompoundSelector: function (t) {
          var e = t.split(/([\.\[])/g),
            ...
            o = "",
            n = -1;
          for ("" === e[0] && e.shift(), n = 0; n < e.length; n++)
            n % 2 == 0 && (o = ""), (o += e[n]), n % 2 != 0 && i.push(o);
          return i;
        },
          ...
          for (
            e.callActions("beforeUpdateControls", arguments),
              t.filter
                ...
                : (o.filter = e.state.activeFilter.selector),
              t.sort
                ? (o.sort = e.buildSortString(t.sort))
                : (o.sort = e.buildSortString(e.state.activeSort)),
              o.filter === e.config.selectors.target && (o.filter = "all"),
        ...
        insertTargets: function (t, e) {
          var i,
            ...
            l = -1;
          if (
            (o.callActions("beforeInsertTargets", arguments),
            void 0 === t.index && (t.index = 0),
            (i = o.getNextSibling(t.index, t.sibling, t.position)),
            (s = o.dom.document.createDocumentFragment()),
            (n = i ? f.index(i, o.config.selectors.target) : o.targets.length),
            t.collection)
          ) {
            for (l = 0; (r = t.collection[l]); l++) {
              if (-1 < o.dom.targets.indexOf(r))
                throw new Error(h.messages.errorInsertPreexistingElement());
              (r.style.display = "none"),
                s.appendChild(r),
                s.appendChild(o.dom.document.createTextNode(" ")),
                f.isElement(r, o.dom.document) &&
                  r.matches(o.config.selectors.target) &&
                  ((a = new h.Target()).init(r, o),
                  (a.isInDom = !0),
                  o.targets.splice(n, 0, a),
                  n++);
            }
            o.dom.parent.insertBefore(s, i);
          }
        ...
        getNextSibling: function (t, e, i) {
          ...
          return (
            ...
            e && "before" === i
              ...
              : 0 < o.targets.length && void 0 !== t
              ? (n =
                  t < o.targets.length || !o.targets.length
                    ? o.targets[t].dom.el
                    : o.targets[o.targets.length - 1].dom.el.nextElementSibling)
              : 0 === o.targets.length &&
                0 < o.dom.parent.children.length &&
                (o.config.layout.siblingAfter
                  ? (n = o.config.layout.siblingAfter)
                  : o.config.layout.siblingBefore
                  ? (n = o.config.layout.siblingBefore.nextElementSibling)
                  : o.dom.parent.children[0]),
            o.callFilters("elementGetNextSibling", n, arguments)
          );
        },
        filterOperation: function (t) {
          ...
          for (
            ...
            (o = t.newFilter.collection
              ? -1 < t.newFilter.collection.indexOf(n.dom.el)
              : "" !== t.newFilter.selector &&
                n.dom.el.matches(t.newFilter.selector)),
              this.evaluateHideShow(o, n, i, t);
          if (t.toRemove.length)
            for (s = 0; (n = t.show[s]); s++)
              -1 < t.toRemove.indexOf(n) &&
                (t.show.splice(s, 1),
                -1 < (e = t.toShow.indexOf(n)) && t.toShow.splice(e, 1),
                t.toHide.push(n),
                t.hide.push(n),
                s--);
        ...
        sortOperation: function (i) {
          var t,
            ...
            s = -1;
          if (
            (o.callActions("beforeSortOperation", arguments),
            (i.startOrder = o.targets),
            i.newSort.collection)
          ) {
            for (e = [], s = 0; (t = i.newSort.collection[s]); s++) {
              if (o.dom.targets.indexOf(t) < 0)
                throw new Error(h.messages.errorSortNonExistentElement());
              (n = new h.Target()).init(t, o), (n.isInDom = !0), e.push(n);
            }
            i.newOrder = e;
          } else
            "random" === i.newSort.order
              ? (i.newOrder = f.arrayShuffle(i.startOrder))
              : "" === i.newSort.attribute
              ? ((i.newOrder = o.origOrder.slice()),
                "desc" === i.newSort.order && i.newOrder.reverse())
              : ((i.newOrder = i.startOrder.slice()),
                i.newOrder.sort(function (t, e) {
        ...
        getAttributeValue: function (t, e) {
          ...
          return (
            null === (i = t.dom.el.getAttribute("data-" + e)) &&
              ...
              console.warn(
                h.messages.warningInconsistentSortingAttributes({
                  attribute: "data-" + e,
                })
              ),
        ...
        printSort: function (t, e) {
          var i,
            o = this,
            n = t ? e.newOrder : e.startOrder,
            s = t ? e.startOrder : e.newOrder,
            a = n.length ? n[n.length - 1].dom.el.nextElementSibling : null,
            r = u.document.createDocumentFragment(),
            l = null,
            c = null,
            d = -1;
          for (
            o.callActions("beforePrintSort", arguments), d = 0;
            (l = n[d]);
            d++
          )
            "absolute" !== (c = l.dom.el).style.position &&
              (f.removeWhitespace(c.previousSibling),
              c.parentElement.removeChild(c));
          for (
            (i = a ? a.previousSibling : o.dom.parent.lastChild) &&
              "#text" === i.nodeName &&
              f.removeWhitespace(i),
              d = 0;
            (l = s[d]);
            d++
          )
            (c = l.dom.el),
              f.isElement(r.lastChild) &&
                r.appendChild(u.document.createTextNode(" ")),
              r.appendChild(c);
          o.dom.parent.firstChild &&
            o.dom.parent.firstChild !== a &&
            r.insertBefore(u.document.createTextNode(" "), r.childNodes[0]),
            a
              ? (r.appendChild(u.document.createTextNode(" ")),
                o.dom.parent.insertBefore(r, a))
              : o.dom.parent.appendChild(r),
            o.callActions("afterPrintSort", arguments);
        },
        parseSortString: function (t, e) {
          for (
            var i, o = t.split(" "), n = e, s = -1, s = 0;
            s < o.length;
            s++
          ) {
            switch (
            ...
            s < o.length - 1 &&
              ((n.next = new h.CommandSort()), f.freeze(n), (n = n.next));
          }
        ...
        parseEffects: function () {
          ...
          (t.effectsIn = new h.StyleData()),
          (t.effectsOut = new h.StyleData()),
          (t.transformIn = []),
          (t.transformOut = []),
          ...
          h.transformDefaults))
            h.transformDefaults[e] instanceof h.TransformData &&
              (t.parseEffect(e, i, t.effectsIn, t.transformIn),
        ...
        parseEffect: function (t, e, i, o, n) {
          var s,
            a,
            r,
            l = this,
          ...
          if (
            ...
            throw new TypeError(
              h.messages.errorConfigInvalidAnimationEffects()
            );
          if (e.indexOf(t) < 0) "stagger" === t && (l.staggerDuration = 0);
          else {
            switch (
              (-1 < (s = e.indexOf(t + "(")) &&
                ((a = e.substring(s)), (c = /\(([^)]+)\)/.exec(a)[1])),
              t)
            ) {
              case "fade":
              ...
              default:
                if (
                  (n && l.config.animation.reverseOut && "scale" !== t
                    ? (i[t].value =
                        -1 * (c ? parseFloat(c) : h.transformDefaults[t].value))
                    : (i[t].value = c
                        ? parseFloat(c)
                        : h.transformDefaults[t].value),
                  c)
                ) {
                  for (p = 0; (r = d[p]); p++)
                    if (-1 < c.indexOf(r)) {
                ...
                } else i[t].unit = h.transformDefaults[t].unit;
        ...
        buildState: function (t) {
          var e = this,
            ...
            n = -1;
          for (
            e.callActions("beforeBuildState", arguments), n = 0;
            (o = e.targets[n]);
            n++
          )
            (!t.toRemove.length || t.toRemove.indexOf(o) < 0) &&
              i.targets.push(o.dom.el);
          for (n = 0; (o = t.matching[n]); n++) i.matching.push(o.dom.el);
          for (n = 0; (o = t.show[n]); n++) i.show.push(o.dom.el);
          for (n = 0; (o = t.hide[n]); n++)
            (!t.toRemove.length || t.toRemove.indexOf(o) < 0) &&
              i.hide.push(o.dom.el);
          return (
            (i.id = e.id),
        ...
        goMix: function (t, e) {
          ...
          return (
            ...
            h.events.fire(
              "mixStart",
              i.dom.container,
              { state: e.startState, futureState: e.newState, instance: i },
              i.dom.document
            ),
            ...
            (o = i.userDeferred
              ? i.userDeferred
              : (i.userDeferred = f.defer(h.libraries))),
            (i.isBusy = !0),
            t && h.features.has.transitions
              ? (u.pageYOffset !== e.docState.scrollTop &&
                  u.scrollTo(e.docState.scrollLeft, e.docState.scrollTop),
                i.config.animation.applyPerspective &&
                  ((i.dom.parent.style[h.features.perspectiveProp] =
                    i.config.animation.perspectiveDistance),
                  (i.dom.parent.style[h.features.perspectiveOriginProp] =
                ...
                i.config.animation.animateResizeContainer &&
                  ...
                  (i.dom.parent.style.height = e.startHeight + "px"),
                i.config.animation.animateResizeContainer &&
                  e.startWidth !== e.newWidth &&
                  e.viewportDeltaX !== e.startWidth - e.newWidth &&
                  (i.dom.parent.style.width = e.startWidth + "px"),
                e.startHeight === e.newHeight &&
                  (i.dom.parent.style.height = e.startHeight + "px"),
                e.startWidth === e.newWidth &&
                  (i.dom.parent.style.width = e.startWidth + "px"),
        ...
        getStartMixData: function (t) {
          var e = this,
            i = u.getComputedStyle(e.dom.parent),
            o = e.dom.parent.getBoundingClientRect(),
            n = null,
            s = {},
            a = -1,
            r = i[h.features.boxSizingProp];
          for (
            e.incPadding = "border-box" === r,
              e.callActions("beforeGetStartMixData", arguments),
              a = 0;
            (n = t.show[a]);
            a++
          )
            (s = n.getPosData()), (t.showPosData[a] = { startPosData: s });
          for (a = 0; (n = t.toHide[a]); a++)
            (s = n.getPosData()), (t.toHidePosData[a] = { startPosData: s });
          (t.startX = o.left),
            (t.startY = o.top),
        ...
        setInter: function (t) {
          ...
          for (
            ...
            i.show();
          t.willChangeLayout &&
            (f.removeClass(e.dom.container, t.startContainerClassName),
            f.addClass(e.dom.container, t.newContainerClassName)),
        ...
        getFinalMixData: function (t) {
          var e,
            ...
            s = -1;
          for (
            i.callActions("beforeGetFinalMixData", arguments), s = 0;
            (n = t.show[s]);
            s++
          )
            t.showPosData[s].finalPosData = n.getPosData();
          for (s = 0; (n = t.toHide[s]); s++)
            t.toHidePosData[s].finalPosData = n.getPosData();
          for (
            (i.config.animation.clampHeight || i.config.animation.clampWidth) &&
              (i.dom.parent.style.height = i.dom.parent.style.width = i.dom.parent.style.overflow =
                ""),
              i.incPadding || (o = u.getComputedStyle(i.dom.parent)),
              e = i.dom.parent.getBoundingClientRect(),
              t.newX = e.left,
              t.newY = e.top,
              t.newHeight = i.incPadding
                ...
                : e.height -
                  ...
                  parseFloat(o.borderTop) -
                  parseFloat(o.borderBottom),
              t.newWidth = i.incPadding
                ? e.width
                : e.width -
                  parseFloat(o.paddingLeft) -
                  parseFloat(o.paddingRight) -
                  parseFloat(o.borderLeft) -
                  parseFloat(o.borderRight),
              t.viewportDeltaX =
            ...
            n.hide();
          for (s = 0; (n = t.toHide[s]); s++) n.show();
          t.willChangeLayout &&
            (f.removeClass(i.dom.container, t.newContainerClassName),
            f.addClass(i.dom.container, i.config.layout.containerClassName)),
        ...
        getTweenData: function (t) {
          var e = this,
            ...
            d = -1;
          for (
            e.callActions("beforeGetTweenData", arguments), c = 0;
            (i = t.show[c]);
            c++
          )
            for (
              (o = t.showPosData[c]).posIn = new h.StyleData(),
                o.posOut = new h.StyleData(),
                o.tweenData = new h.StyleData(),
                i.isShown
                  ? ((o.posIn.x = o.startPosData.x - o.interPosData.x),
                    (o.posIn.y = o.startPosData.y - o.interPosData.y))
                  : (o.posIn.x = o.posIn.y = 0),
                ...
                i.isShown ||
                  ...
                  ((o.posIn.x = o.posOut.x), (o.posIn.y = o.posOut.y)),
                ...
                e.config.animation.animateResizeTargets &&
                  ...
                  (r =
                    (o.startPosData.width || o.finalPosData.width) -
                    o.interPosData.width),
                  (o.posIn.marginRight = o.startPosData.marginRight - r),
                  (l =
                    (o.startPosData.height || o.finalPosData.height) -
                    o.interPosData.height),
                  (o.posIn.marginBottom = o.startPosData.marginBottom - l),
                  (o.posOut.width = o.finalPosData.width),
                  (o.posOut.height = o.finalPosData.height),
                  (r =
                    (o.finalPosData.width || o.startPosData.width) -
                    o.interPosData.width),
                  (o.posOut.marginRight = o.finalPosData.marginRight - r),
                  (l =
                    (o.finalPosData.height || o.startPosData.height) -
                    o.interPosData.height),
                  (o.posOut.marginBottom = o.finalPosData.marginBottom - l),
                  (o.tweenData.width = o.posOut.width - o.posIn.width),
                  (o.tweenData.height = o.posOut.height - o.posIn.height),
                  (o.tweenData.marginRight =
                    o.posOut.marginRight - o.posIn.marginRight),
                  (o.tweenData.marginBottom =
                    o.posOut.marginBottom - o.posIn.marginBottom)),
                d = 0;
              (s = n[d]);
              d++
            )
              (a = e.effectsIn[s]) instanceof h.TransformData &&
                a.value &&
                ((o.posIn[s].value = a.value),
                (o.posOut[s].value = 0),
                (o.tweenData[s].value = o.posOut[s].value - o.posIn[s].value),
                (o.posIn[s].unit = o.posOut[s].unit = o.tweenData[s].unit =
                  a.unit));
          for (c = 0; (i = t.toHide[c]); c++)
            for (
              (o = t.toHidePosData[c]).posIn = new h.StyleData(),
                o.posOut = new h.StyleData(),
                o.tweenData = new h.StyleData(),
                ...
                e.config.animation.animateResizeTargets &&
                  ((o.posIn.width = o.startPosData.width),
                  (o.posIn.height = o.startPosData.height),
                  (r = o.startPosData.width - o.interPosData.width),
                  (o.posIn.marginRight = o.startPosData.marginRight - r),
                  (l = o.startPosData.height - o.interPosData.height),
                  (o.posIn.marginBottom = o.startPosData.marginBottom - l)),
                o.posIn.opacity = 1,
              ...
              (a = e.effectsOut[s]) instanceof h.TransformData &&
                a.value &&
                ((o.posIn[s].value = 0),
        ...
        moveTargets: function (t) {
          ...
          for (
            e.callActions("beforeMoveTargets", arguments), l = 0;
            (i = t.show[l]);
            l++
          )
            (o = new h.IMoveData()),
              ...
              (a = e.willTransition(s, t.hasEffect, n.posIn, n.posOut)) && r++,
              i.show(),
              (o.posIn = n.posIn),
              (o.posOut = n.posOut),
              (o.statusChange = s),
          ...
          for (l = 0; (i = t.toHide[l]); l++)
            (n = t.toHidePosData[l]),
              (o = new h.IMoveData()),
              (s = "hide"),
              (a = e.willTransition(s, n.posIn, n.posOut)),
              (o.posIn = n.posIn),
              (o.posOut = n.posOut),
              (o.statusChange = s),
              (o.staggerIndex = l),
          ...
          e.config.animation.animateResizeContainer &&
            ((e.dom.parent.style[h.features.transitionProp] =
              "height " +
        ...
        hasEffect: function () {
          ...
          for (n = 0; (t = i[n]); n++)
            if (
              0 !==
              ("undefined" !== (e = this.effectsIn[t]).value ? e.value : e)
            ) {
              o = !0;
              break;
            }
        ...
        willTransition: function (t, e, i, o) {
          var n = !1,
            n =
              !!f.isVisible(this.dom.container) &&
              (!!(("none" !== t && e) || i.x !== o.x || i.y !== o.y) ||
        ...
        cleanUp: function (t) {
          var e,
            ...
            a = -1;
          for (
            o.callActions("beforeCleanUp", arguments),
              a = o.targetsMoved = o.targetsImmovable = o.targetsBound = o.targetsDone = 0;
            (n = t.show[a]);
            a++
          )
            n.cleanUp(), n.show();
          for (a = 0; (n = t.toHide[a]); a++) n.cleanUp(), n.hide();
          if (
            (t.willSort && o.printSort(!1, t),
            (o.dom.parent.style[
              h.features.transitionProp
            ] = o.dom.parent.style.height = o.dom.parent.style.width = o.dom.parent.style.overflow = o.dom.parent.style[
              h.features.perspectiveProp
            ] = o.dom.parent.style[h.features.perspectiveOriginProp] = ""),
            t.willChangeLayout &&
              (f.removeClass(o.dom.container, t.startContainerClassName),
              f.addClass(o.dom.container, t.newContainerClassName)),
            t.toRemove.length)
          ) {
            for (a = 0; (n = o.targets[a]); a++)
              -1 < t.toRemove.indexOf(n) &&
                ((e = n.dom.el.previousSibling) &&
                  "#text" === e.nodeName &&
                  (s = n.dom.el.nextSibling) &&
                  "#text" === s.nodeName &&
                  f.removeWhitespace(e),
                t.willSort || o.dom.parent.removeChild(n.dom.el),
                o.targets.splice(a, 1),
                (n.isInDom = !1),
                a--);
            o.origOrder = o.targets;
          }
          t.willSort && (o.targets = t.newOrder),
            (o.state = t.newState),
            (o.lastOperation = t),
            (o.dom.targets = o.state.targets),
            h.events.fire(
              "mixEnd",
              o.dom.container,
              { state: o.state, instance: o },
              o.dom.document
            ),
            "function" == typeof o.config.callbacks.onMixEnd &&
              o.config.callbacks.onMixEnd.call(o.dom.container, o.state, o),
            t.hasFailed &&
              (h.events.fire(
                "mixFail",
                o.dom.container,
              ...
              "function" == typeof o.config.callbacks.onMixFail &&
                o.config.callbacks.onMixFail.call(o.dom.container, o.state, o),
              f.addClass(
                o.dom.container,
                f.getClassname(
                  o.config.classNames,
            ...
            "function" == typeof o.userCallback &&
              o.userCallback.call(o.dom.container, o.state, o),
            "function" == typeof o.userDeferred.resolve &&
              o.userDeferred.resolve(o.state),
            (o.userCallback = null),
            (o.userDeferred = null),
            (o.lastClicked = null),
            (o.isToggling = !1),
            (o.isBusy = !1),
            o.queue.length &&
              (o.callActions("beforeReadQueueCleanUp", arguments),
              (i = o.queue.shift()),
              (o.userDeferred = i.deferred),
              (o.isToggling = i.isToggling),
              (o.lastClicked = i.triggerElement),
              i.instruction.command instanceof h.CommandMultimix
                ? o.multimix.apply(o, i.args)
                : o.dataset.apply(o, i.args)),
            o.callActions("afterCleanUp", arguments);
        },
        parseMultimixArgs: function (t) {
          var e,
            i = this,
            o = new h.UserInstruction(),
            n = -1;
          for (
            o.animate = i.config.animation.enable,
              o.command = new h.CommandMultimix(),
              n = 0;
            n < t.length;
            n++
          )
            null !== (e = t[n]) &&
              ("object" == typeof e
                ? f.extend(o.command, e)
                : "boolean" == typeof e
                ? (o.animate = e)
                : "function" == typeof e && (o.callback = e));
          return (
            !o.command.insert ||
              o.command.insert instanceof h.CommandInsert ||
              (o.command.insert = i.parseInsertArgs([
                o.command.insert,
              ]).command),
            !o.command.remove ||
              o.command.remove instanceof h.CommandRemove ||
              (o.command.remove = i.parseRemoveArgs([
                o.command.remove,
              ]).command),
            !o.command.filter ||
              o.command.filter instanceof h.CommandFilter ||
              (o.command.filter = i.parseFilterArgs([
                o.command.filter,
              ]).command),
            !o.command.sort ||
              o.command.sort instanceof h.CommandSort ||
              (o.command.sort = i.parseSortArgs([o.command.sort]).command),
            !o.command.changeLayout ||
              o.command.changeLayout instanceof h.CommandChangeLayout ||
              (o.command.changeLayout = i.parseChangeLayoutArgs([
                o.command.changeLayout,
              ]).command),
            (o = i.callFilters("instructionParseMultimixArgs", o, arguments)),
            f.freeze(o),
            o
          );
        },
        parseFilterArgs: function (t) {
          var e,
            i = new h.UserInstruction(),
            o = -1;
          for (
            i.animate = this.config.animation.enable,
              i.command = new h.CommandFilter(),
              o = 0;
            o < t.length;
            o++
          )
            "string" == typeof (e = t[o])
              ? (i.command.selector = e)
              : null === e
              ? (i.command.collection = [])
              : "object" == typeof e && f.isElement(e, this.dom.document)
              ? (i.command.collection = [e])
              : "object" == typeof e && void 0 !== e.length
              ? (i.command.collection = f.arrayFromList(e))
              : "object" == typeof e
              ? f.extend(i.command, e)
              : "boolean" == typeof e
              ? (i.animate = e)
              : "function" == typeof e && (i.callback = e);
          if (i.command.selector && i.command.collection)
            throw new Error(h.messages.errorFilterInvalidArguments());
          return (
            (i = this.callFilters("instructionParseFilterArgs", i, arguments)),
            f.freeze(i),
            i
          );
        },
        parseSortArgs: function (t) {
          ...
          return (
            o && (i.command = this.parseSortString(o, i.command)),
            (i = this.callFilters("instructionParseSortArgs", i, arguments)),
            f.freeze(i),
            i
          );
        },
        parseInsertArgs: function (t) {
          ...
          for (
            ...
            null !== (e = t[o]) &&
              ("number" == typeof e
                ...
                ? (i.command.position = e)
                : "string" == typeof e
                ? (i.command.collection = f.arrayFromList(
                    f.createElement(e).childNodes
                  ))
                : "object" == typeof e && f.isElement(e, this.dom.document)
                ...
                ? i.command.collection.length
                  ? (i.command.sibling = e[0])
                  : (i.command.collection = e)
                : "object" == typeof e && e.childNodes && e.childNodes.length
                ? i.command.collection.length
                  ? (i.command.sibling = e.childNodes[0])
                  : (i.command.collection = f.arrayFromList(e.childNodes))
                : "object" == typeof e
                ? f.extend(i.command, e)
                : "boolean" == typeof e
                ? (i.animate = e)
          ...
          if (i.command.index && i.command.sibling)
            throw new Error(h.messages.errorInsertInvalidArguments());
          return (
            !i.command.collection.length &&
              this.config.debug.showWarnings &&
              console.warn(h.messages.warningInsertNoElements()),
            (i = this.callFilters("instructionParseInsertArgs", i, arguments)),
            f.freeze(i),
            i
          );
        },
        parseRemoveArgs: function (t) {
          var e,
            i,
            o = this,
            n = new h.UserInstruction(),
            s = -1;
          for (
            n.animate = o.config.animation.enable,
              n.command = new h.CommandRemove(),
              s = 0;
            s < t.length;
            s++
          )
            if (null !== (i = t[s]))
              switch (typeof i) {
                case "number":
                  o.targets[i] && (n.command.targets[0] = o.targets[i]);
                  break;
                case "string":
                  n.command.collection = f.arrayFromList(
                    o.dom.parent.querySelectorAll(i)
                  );
                  break;
                case "object":
                  i && i.length
                    ? (n.command.collection = i)
                    : f.isElement(i, o.dom.document)
                    ? (n.command.collection = [i])
                    : f.extend(n.command, i);
                  break;
                case "boolean":
                  n.animate = i;
                  break;
          ...
          if (n.command.collection.length)
            for (s = 0; (e = o.targets[s]); s++)
              -1 < n.command.collection.indexOf(e.dom.el) &&
                n.command.targets.push(e);
          return (
            !n.command.targets.length &&
              o.config.debug.showWarnings &&
              console.warn(h.messages.warningRemoveNoElements()),
            f.freeze(n),
            n
          );
        },
        parseDatasetArgs: function (t) {
          ...
          for (
            ...
            if (null !== (e = t[o]))
              switch (typeof e) {
                case "object":
                  Array.isArray(e) || "number" == typeof e.length
                    ? (i.command.dataset = e)
                    : f.extend(i.command, e);
                  break;
                case "boolean":
        ...
        parseChangeLayoutArgs: function (t) {
          ...
          for (
            i.animate = this.config.animation.enable,
              i.command = new h.CommandChangeLayout(),
              o = 0;
            o < t.length;
            o++
          )
            ...
            i.queue.length < i.config.animation.queueLimit
              ? ((t.deferred = o),
                ...
                i.config.controls.enable &&
                  (i.isToggling
                    ? (i.buildToggleArray(t.instruction.command),
                      (e = i.getToggleSelector()),
                      i.updateControls({ filter: { selector: e } }))
                    : i.updateControls(t.instruction.command)))
              : (i.config.debug.showWarnings &&
                  console.warn(h.messages.warningMultimixInstanceQueueFull()),
                o.resolve(i.state),
                h.events.fire(
                  "mixBusy",
                  i.dom.container,
                ...
                "function" == typeof i.config.callbacks.onMixBusy &&
                  i.config.callbacks.onMixBusy.call(
                    i.dom.container,
                    i.state,
                    i
                  )),
            i.callFilters("promiseQueueMix", o.promise, arguments)
          );
        },
        getDataOperation: function (t) {
          ...
          if (e.dom.targets.length && !(o = e.state.activeDataset || []).length)
            throw new Error(h.messages.errorDatasetNotSet());
          return (
            (i.id = f.randomHex()),
            ...
            e.config.animation.enable &&
              (e.getStartMixData(i),
              e.setInter(i),
              (i.docState = f.getDocumentState(e.dom.document)),
              e.getInterMixData(i),
              e.setFinal(i),
              e.getFinalMixData(i),
              e.parseEffects(),
        ...
        diffDatasets: function (t) {
          var e = this,
            ...
            u = -1;
          for (
            e.callActions("beforeDiffDatasets", arguments), u = 0;
            (s = t.newDataset[u]);
            u++
          ) {
            if (
              void 0 === (p = s[e.config.data.uidKey]) ||
              p.toString().length < 1
            )
              throw new TypeError(
                h.messages.errorDatasetInvalidUidKey({
                  uidKey: e.config.data.uidKey,
                })
              );
            if (d[p])
              throw new Error(h.messages.errorDatasetDuplicateUid({ uid: p }));
            (d[p] = !0),
              (a = e.cache[p]) instanceof h.Target
                ? (e.config.data.dirtyCheck &&
                    !f.deepEquals(s, a.data) &&
                    ((r = a.render(s)),
                    (a.data = s),
                    r !== a.dom.el &&
                      (a.isInDom &&
                        (a.unbindEvents(),
                        e.dom.parent.replaceChild(r, a.dom.el)),
                      a.isShown || (r.style.display = "none"),
                      (a.dom.el = r),
                      a.isInDom && a.bindEvents())),
                  (r = a.dom.el))
                : ((a = new h.Target()).init(null, e, s), a.hide()),
              a.isInDom
                ? ((c = a.dom.el.nextElementSibling),
                  o.push(p),
                  l &&
                    (l.lastElementChild &&
                      l.appendChild(e.dom.document.createTextNode(" ")),
                    e.insertDatasetFrag(l, a.dom.el, n),
                    (l = null)))
                : ((l = l || e.dom.document.createDocumentFragment())
                    .lastElementChild &&
                    l.appendChild(e.dom.document.createTextNode(" ")),
                  l.appendChild(a.dom.el),
                  (a.isInDom = !0),
                  a.unbindEvents(),
                  a.bindEvents(),
                  a.hide(),
          ...
          for (
            l &&
              ((c = c || e.config.layout.siblingAfter) &&
                l.appendChild(e.dom.document.createTextNode(" ")),
              e.insertDatasetFrag(l, c, n)),
              u = 0;
            (s = t.startDataset[u]);
            u++
          )
            (p = s[e.config.data.uidKey]),
              (a = e.cache[p]),
              t.show.indexOf(a) < 0
                ? (t.hide.push(a), t.toHide.push(a), t.toRemove.push(a))
                : i.push(p);
        ...
        insertDatasetFrag: function (t, e, i) {
          var o = e
            ? f.arrayFromList(this.dom.parent.children).indexOf(e)
            : this.targets.length;
          for (this.dom.parent.insertBefore(t, e); i.length; )
            this.targets.splice(o, 0, i.shift()), o++;
        },
        ...
        toggleOn: function () {
          ...
          return (
            ...
            e.multimix({ filter: t }, i.animate, i.callback)
          );
        },
        toggleOff: function () {
          var t,
            ...
            i = e.parseFilterArgs(arguments),
            o = i.command.selector,
            n = e.toggleArray.indexOf(o);
          return (
            (e.isToggling = !0),
            -1 < n && e.toggleArray.splice(n, 1),
            (t = e.getToggleSelector()),
            e.multimix({ filter: t }, i.animate, i.callback)
          );
        },
        ...
        dataset: function () {
          var t,
            e,
            i = this,
            o = i.parseDatasetArgs(arguments),
            n = null;
          return (
            i.callActions("beforeDataset", arguments),
            i.isBusy
              ? (((n = new h.QueueItem()).args = arguments),
                (n.instruction = o),
                i.queueMix(n))
              : (o.callback && (i.userCallback = o.callback),
                (e =
                  o.animate ^ i.config.animation.enable
                    ? o.animate
                    : i.config.animation.enable),
                (t = i.getDataOperation(o.command.dataset)),
                i.goMix(e, t))
          );
        },
        multimix: function () {
          ...
          return (
            i.callActions("beforeMultimix", arguments),
            i.isBusy
              ? (((o = new h.QueueItem()).args = arguments),
                (o.instruction = n),
                (o.triggerElement = i.lastClicked),
                (o.isToggling = i.isToggling),
                i.queueMix(o))
              : ((t = i.getOperation(n.command)),
                i.config.controls.enable &&
                  (n.command.filter &&
                    !i.isToggling &&
                    ((i.toggleArray.length = 0), i.buildToggleArray(t.command)),
                  i.queue.length < 1 && i.updateControls(t.command)),
                n.callback && (i.userCallback = n.callback),
                (e =
          ...
          return (
            ...
            e.isBusy
              ? (e.config.debug.showWarnings &&
                  console.warn(h.messages.warningGetOperationInstanceBusy()),
                null)
              : (a && e.insertTargets(a, r),
                ...
                i &&
                  ...
                  (r.newSort = i),
                  (r.willSort = e.willSort(i, r.startState.activeSort)),
                  r.willSort && e.sortOperation(r)),
                (r.startFilter = r.startState.activeFilter),
                (r.newFilter =
                  o || f.extend(new h.CommandFilter(), r.startFilter)),
                ...
                n
                  ? ((r.newContainerClassName = n.containerClassName),
                ...
                e.config.animation.enable &&
                  (e.getStartMixData(r),
                  e.setInter(r),
                  (r.docState = f.getDocumentState(e.dom.document)),
                  e.getInterMixData(r),
                  e.setFinal(r),
                  e.getFinalMixData(r),
                  e.parseEffects(),
                  (r.hasEffect = e.hasEffect()),
                  e.getTweenData(r)),
                r.willSort && (e.targets = r.newOrder),
                (r.newState = e.buildState(r)),
                e.callFilters("operationMappedGetOperation", r, arguments))
          );
        },
        tween: function (t, e) {
          var i,
          ...
          for (
            ...
            (n = t.showPosData[s]), o.applyTween(n, e);
          for (s = 0; (o = t.hide[s]); s++)
            o.isShown && o.hide(),
              -1 < (i = t.toHide.indexOf(o)) &&
                ((n = t.toHidePosData[i]),
                o.isShown || o.show(),
                o.applyTween(n, e));
        },
        ...
        forceRender: function () {
          var t = this,
            ...
            o = "";
          for (o in t.cache)
            (i = (e = t.cache[o]).render(e.data)) !== e.dom.el &&
              (e.isInDom &&
                (e.unbindEvents(), t.dom.parent.replaceChild(i, e.dom.el)),
        ...
        destroy: function (t) {
          var e = this,
            ...
            n = 0;
          for (
            e.callActions("beforeDestroy", arguments), n = 0;
            (i = e.controls[n]);
            n++
          )
            i.removeBinding(e);
          for (n = 0; (o = e.targets[n]); n++) t && o.show(), o.unbindEvents();
          e.dom.container.id.match(/^MixItUp/) &&
            e.dom.container.removeAttribute("id"),
            delete h.instances[e.id],
            e.callActions("afterDestroy", arguments);
        },
      }),
      (h.IMoveData = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.posIn = null),
          (this.posOut = null),
      ...
      h.BaseStatic.call(h.IMoveData),
      (h.IMoveData.prototype = Object.create(h.Base.prototype)),
      (h.IMoveData.prototype.constructor = h.IMoveData),
      (h.TargetDom = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.el = null),
          this.callActions("afterConstruct"),
      ...
      h.BaseStatic.call(h.TargetDom),
      (h.TargetDom.prototype = Object.create(h.Base.prototype)),
      (h.TargetDom.prototype.constructor = h.TargetDom),
      (h.Target = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.id = ""),
          ...
          (this.operation = null),
          (this.data = null),
          (this.dom = new h.TargetDom()),
          this.callActions("afterConstruct"),
          f.seal(this);
      }),
      h.BaseStatic.call(h.Target),
      (h.Target.prototype = Object.create(h.Base.prototype)),
      f.extend(h.Target.prototype, {
        ...
        init: function (t, e, i) {
          ...
          if (
            ...
            if (
              void 0 === (n = i[e.config.data.uidKey]) ||
              n.toString().length < 1
            )
              throw new TypeError(
                h.messages.errorDatasetInvalidUidKey({
        ...
        render: function (t) {
          ...
          if (
            ...
            throw new TypeError(h.messages.errorDatasetRendererNotSet());
          return (
            (e = i(t)) && "object" == typeof e && f.isElement(e)
              ? (o = e)
              : "string" == typeof e &&
        ...
        applyTween: function (t, e) {
          ...
          for (
            n.callActions("beforeApplyTween", arguments),
              r.x = s.x,
              r.y = s.y,
              0 === e ? n.hide() : n.isShown || n.show(),
              l = 0;
            (i = h.features.TWEENABLE[l]);
            l++
          )
            if (((o = t.tweenData[i]), "x" === i)) {
              ...
              if (!o) continue;
              r.y = s.y + o * e;
            } else if (o instanceof h.TransformData) {
              if (!o.value) continue;
              ...
              if (!o) continue;
              (r[i] = s[i] + o * e), (n.dom.el.style[i] = r[i]);
            }
          (r.x || r.y) && a.unshift("translate(" + r.x + "px, " + r.y + "px)"),
            a.length &&
              (n.dom.el.style[h.features.transformProp] = a.join(" ")),
        ...
        applyStylesIn: function (t) {
          ...
          e.callActions("beforeApplyStylesIn", arguments),
            n.push("translate(" + i.x + "px, " + i.y + "px)"),
            e.mixer.config.animation.animateResizeTargets &&
              ("show" !== t.statusChange &&
                ((e.dom.el.style.width = i.width + "px"),
            ...
            "show" === t.statusChange && (n = n.concat(e.mixer.transformIn)),
            (e.dom.el.style[h.features.transformProp] = n.join(" ")),
        ...
        applyStylesOut: function (t) {
          ...
          if (
            ...
            i.push(
              e.writeTransitionRule(h.features.transformRule, t.staggerIndex)
            ),
            "none" !== t.statusChange &&
              i.push(
                e.writeTransitionRule("opacity", t.staggerIndex, t.duration)
              ),
            n &&
              (i.push(
              ...
              i.push(
                e.writeTransitionRule("height", t.staggerIndex, t.duration)
              ),
              i.push(
                e.writeTransitionRule("margin", t.staggerIndex, t.duration)
              )),
            !t.callback)
          )
            return (
          ...
          switch (
            ...
            e.mixer.config.animation.nudge ||
              "hide" !== t.statusChange ||
              o.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"),
            t.statusChange)
          ) {
            case "hide":
          ...
          (e.mixer.config.animation.nudge ||
            (!e.mixer.config.animation.nudge && "hide" !== t.statusChange)) &&
            o.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"),
            (e.dom.el.style[h.features.transformProp] = o.join(" ")),
            e.callActions("afterApplyStylesOut", arguments);
        },
        writeTransitionRule: function (t, e, i) {
          var o = this.getDelay(e),
            n =
              t +
              " " +
              (0 < i ? i : this.mixer.config.animation.duration) +
              "ms " +
              o +
              "ms " +
              ("opacity" === t ? "linear" : this.mixer.config.animation.easing);
          return this.callFilters("ruleWriteTransitionRule", n, arguments);
        },
        getDelay: function (t) {
          var e,
            i = this;
          return (
            "function" == typeof i.mixer.config.animation.staggerSequence &&
              (t = i.mixer.config.animation.staggerSequence.call(
                i,
                t,
                i.state
              )),
        ...
        applyTransition: function (t) {
          ...
          this.callActions("beforeApplyTransition", arguments),
            (this.dom.el.style[h.features.transitionProp] = e),
          ...
          e.callActions("beforeHandleTransitionEnd", arguments),
            e.isBound &&
              ...
              (-1 < i.indexOf("transform") ||
                -1 < i.indexOf("opacity") ||
                (o && -1 < i.indexOf("height")) ||
                (o && -1 < i.indexOf("width")) ||
                (o && -1 < i.indexOf("margin"))) &&
        ...
        bindEvents: function () {
          ...
          e.callActions("beforeBindEvents", arguments),
            (t =
              "webkit" === h.features.transitionPrefix
                ? "webkitTransitionEnd"
                : "transitionend"),
            (e.handler = function (t) {
              return e.eventBus(t);
        ...
        getPosData: function (t) {
          ...
          return (
            ...
            (n.x = o.dom.el.offsetLeft),
            (n.y = o.dom.el.offsetTop),
            (o.mixer.config.animation.animateResizeTargets || t) &&
              ((i = o.dom.el.getBoundingClientRect()),
              (n.top = i.top),
              (n.right = i.right),
              (n.bottom = i.bottom),
              (n.left = i.left),
            ...
            o.mixer.config.animation.animateResizeTargets &&
              ((e = u.getComputedStyle(o.dom.el)),
              (n.marginBottom = parseFloat(e.marginBottom)),
              (n.marginRight = parseFloat(e.marginRight))),
            o.callFilters("posDataGetPosData", n, arguments)
          );
        },
        cleanUp: function () {
          var t = this;
          t.callActions("beforeCleanUp", arguments),
            (t.dom.el.style[h.features.transformProp] = ""),
            (t.dom.el.style[h.features.transitionProp] = ""),
      ...
      h.BaseStatic.call(h.Collection),
      (h.Collection.prototype = Object.create(h.Base.prototype)),
      f.extend(h.Collection.prototype, {
        constructor: h.Collection,
        mixitup: function (t) {
          var e = null,
            ...
            n = -1;
          for (
            this.callActions("beforeMixitup"), i.shift(), n = 0;
            (e = this[n]);
            n++
          )
            o.push(e[t].apply(e, i));
      ...
      h.BaseStatic.call(h.Operation),
      (h.Operation.prototype = Object.create(h.Base.prototype)),
      (h.Operation.prototype.constructor = h.Operation),
      (h.State = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.id = ""),
      ...
      h.BaseStatic.call(h.State),
      (h.State.prototype = Object.create(h.Base.prototype)),
      (h.State.prototype.constructor = h.State),
      (h.UserInstruction = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
          (this.command = {}),
          (this.animate = !1),
      ...
      h.BaseStatic.call(h.UserInstruction),
      (h.UserInstruction.prototype = Object.create(h.Base.prototype)),
      (h.UserInstruction.prototype.constructor = h.UserInstruction),
      (h.Messages = function () {
        h.Base.call(this),
          this.callActions("beforeConstruct"),
      ...
      h.BaseStatic.call(h.Messages),
      (h.Messages.prototype = Object.create(h.Base.prototype)),
      (h.Messages.prototype.constructor = h.Messages),
      (h.Messages.prototype.compileTemplates = function () {
        var t,
          e = "";
        for (e in this)
          "string" == typeof (t = this[e]) &&
            (this[f.camelCase(e)] = f.template(t));
      }),
      (h.messages = new h.Messages()),
      (h.Facade = function (t) {
        h.Base.call(this),
      ...
      h.BaseStatic.call(h.Facade),
      (h.Facade.prototype = Object.create(h.Base.prototype)),
      (h.Facade.prototype.constructor = h.Facade),
      "object" == typeof exports && "object" == typeof module
        ...
        : (void 0 !== u.mixitup && "function" == typeof u.mixitup) ||
          (u.mixitup = h),
      h.BaseStatic.call(h.constructor),
      (h.NAME = "mixitup"),
      (h.CORE_VERSION = "3.3.1");
  })(window);
