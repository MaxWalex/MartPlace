...
function(z) {
    ...
    function V(t, e, i) {
        var s = i / 100 * (e - t);
        return 1 === (s = Math.round(t + s).toString(16)).length && (s = "0" + s), s
    }
    ...
    function Y(n, u) {
        ...
        var f, s, m, g, y, t, e = z("<div/>").addClass("jq-ry-group-wrapper").appendTo(n),
            v = z("<div/>").addClass("jq-ry-normal-group").addClass("jq-ry-group").appendTo(e),
            o = z("<div/>").addClass("jq-ry-rated-group").addClass("jq-ry-group").appendTo(e),
            b = 0,
            a = u.rating,
            r = !1;
        ...
        function l(t) {
            ...
            var e = (a = t) / f,
                i = e * m;
            1 < e && (i += (Math.ceil(e) - 1) * y), w(u.ratedFill), (i = u.rtl ? 100 - i : i) < 0 ? i = 0 : 100 < i && (i = 100), o.css("width", i + "%")
        }

        function c() {
            t = s * u.numStars + g * (u.numStars - 1), m = s / t * 100, y = g / t * 100, n.width(t), l()
        }

        function h(t) {
            var e = u.starWidth = t;
            return s = window.parseFloat(u.starWidth.replace("px", "")), v.find("svg").attr({
                width: u.starWidth,
                height: e
            }), o.find("svg").attr({
                width: u.starWidth,
        ...
        function d(t) {
            return u.spacing = t, g = parseFloat(u.spacing.replace("px", "")), v.find("svg:not(:first-child)").css({
                "margin-left": t
        ...
        function p(t) {
            return u.normalFill = t, (u.rtl ? o : v).find("svg").attr({
                fill: u.normalFill
            }), n
        }
        var _ = u.ratedFill;
        ...
        function w(t) {
            var e, i;
            return u.multiColor ? (e = (a - b) / u.maxValue * 100, t = function(t, e, i) {
                if (!t || !e) return null;
                i = G(i) ? i : 0, t = X(t), e = X(e);
                var s = V(t.r, e.r, i),
                    o = V(t.b, e.b, i);
                return "#" + s + V(t.g, e.g, i) + o
            }((i = u.multiColor || {}).startColor || W.startColor, i.endColor || W.endColor, e)) : _ = t, u.ratedFill = t, (u.rtl ? v : o).find("svg").attr({
                fill: u.ratedFill
            }), n
        }

        function x(t) {
            t = !!t, u.rtl = t, p(u.normalFill), l()
        }

        function C(t) {
            u.multiColor = t, w(t || _)
        }

        function S(t) {
            u.numStars = t, f = u.maxValue / u.numStars, v.empty(), o.empty();
            for (var e = 0; e < u.numStars; e++) v.append(z(u.starSvg || U)), o.append(z(u.starSvg || U));
            return h(u.starWidth), p(u.normalFill), d(u.spacing), l(), n
        }

        function k(t) {
            return u.maxValue = t, f = u.maxValue / u.numStars, u.rating > t && I(t), l(), n
        }

        function T(t) {
            return u.precision = t, I(u.rating), n
        }

        function A(t) {
            return u.halfStar = t, n
        }

        function $(t) {
            return u.fullStar = t, n
        }

        function O(t) {
            var e, i, s, o, n, a = v.offset().left,
                r = a + v.width(),
                l = u.maxValue,
                c = t.pageX,
                h = 0;
            if (c < a) h = b;
                ...
                var d = (c - a) / (r - a);
                if (0 < g)
                    for (var p = d *= 100; 0 < p;) m < p ? (h += f, p -= m + y) : (h += p / m * f, p = 0);
                else h = d * u.maxValue;
                i = (e = h) % f, s = f / 2, o = u.halfStar, ((n = u.fullStar) || o) && (n || o && s < i ? e += f - i : (e -= i, 0 < i && (e += s))), h = e
            }
            return u.rtl && (h = l - h), parseFloat(h)
        }

        function D(t) {
            return u.readOnly = t, n.attr("readonly", !0), H(), t || (n.removeAttr("readonly"), n.on("mousemove", M).on("mouseenter", M).on("mouseleave", N).on("click", R).on("rateyo.init", B).on("rateyo.change", L).on("rateyo.set", j)), n
        }

        function I(t) {
            var e = t,
                i = u.maxValue;
            return "string" == typeof e && ("%" === e[e.length - 1] && (e = e.substr(0, e.length - 1), k(i = 100)), e = parseFloat(e)),
                function(t, e, i) {
                    if (!(e <= t && t <= i)) throw Error("Invalid Rating, expected value between " + e + " and " + i)
                }(e, b, i), e = parseFloat(e.toFixed(u.precision)), q(parseFloat(e), b, i), u.rating = e, l(), r && n.trigger("rateyo.set", {
                    rating: e
                }), n
        }
        ...
        function F(t) {
            return u.onChange = t, n
        }

        function M(t) {
            var e = O(t).toFixed(u.precision),
                i = u.maxValue;
            l(e = q(parseFloat(e), b, i)), n.trigger("rateyo.change", {
                rating: e
            })
        }
        ...
        function B(t, e) {
            u.onInit && "function" == typeof u.onInit && u.onInit.apply(this, [e.rating, i])
        }

        function L(t, e) {
            u.onChange && "function" == typeof u.onChange && u.onChange.apply(this, [e.rating, i])
        }

        function j(t, e) {
            u.onSet && "function" == typeof u.onSet && u.onSet.apply(this, [e.rating, i])
        }

        function H() {
            n.off("mousemove", M).off("mouseenter", M).off("mouseleave", N).off("click", R).off("rateyo.init", B).off("rateyo.change", L).off("rateyo.set", j)
        }
        this.rating = function(t) {
            return G(t) ? (I(t), n) : u.rating
        }, this.destroy = function() {
            var s, o;
            return u.readOnly || H(), Y.prototype.collection = (s = n.get(0), o = this.collection, z.each(o, function(t) {
                if (s === this.node) {
                    var e = o.slice(0, t),
                        i = o.slice(t + 1, o.length);
                    return o = e.concat(i), !1
                }
            }), o), n.removeClass("jq-ry-container").children().remove(), n
        }, this.method = function(t) {
            if (!t) throw Error("Method name not specified!");
            if (!G(this[t])) throw Error("Method " + t + " doesn't exist!");
            ...
            return G(e) ? i(e) : u[t]
        }, S(u.numStars), D(u.readOnly), u.rtl && x(u.rtl), this.collection.push(this), this.rating(u.rating, !0), r = !0, n.trigger("rateyo.init", {
            rating: u.rating
        })
    }
    ...
    function c(t, e) {
        var i;
        return z.each(e, function() {
            if (t === this.node) return i = this, !1
        }), i
    }
    Y.prototype.collection = [], window.RateYo = Y, z.fn.rateYo = function() {
        return function(i) {
            var n = Y.prototype.collection,
                t = z(this);
                ...
                if (1 !== e.length || "object" != typeof e[0]) {
                    if (1 <= e.length && "string" == typeof e[0]) {
                        var a = e[0],
                            r = e.slice(1),
                            l = [];
                        return z.each(t, function(t, e) {
                            var i = c(e, n);
                            if (!i) throw Error("Trying to set options before even initialization");
                            var s = i[a];
                            if (!s) throw Error("Method " + a + " does not exist!");
                            var o = s.apply(i, r);
                            l.push(o)
                        }), l = 1 === l.length ? l[0] : l
                    }
            ...
            return i = z.extend({}, s, i), z.each(t, function() {
                var t = c(this, n);
                if (t) return t;
                var e = z(this),
                    s = {},
                    o = z.extend({}, i);
                return z.each(e.data(), function(t, e) {
                    var i;
                    0 === t.indexOf("rateyo") && (i = (i = t.replace(/^rateyo/, ""))[0].toLowerCase() + i.slice(1), s[i] = e, delete o[i])
                }), new Y(z(this), z.extend({}, s, o))
            })
...
function(p) {
    ...
    var u = null,
        f = null;
    ! function() {
        for (var t, o, n, a, r, e = ["webkit", "moz", "o", "ms"], i = p.document.createElement("div"), s = -1, s = 0; s < e.length && !p.requestAnimationFrame; s++) p.requestAnimationFrame = p[e[s] + "RequestAnimationFrame"];
        ...
        void 0 === i.nextElementSibling && Object.defineProperty(p.Element.prototype, "nextElementSibling", {
        ...
        }), (t = p.Element.prototype).matches = t.matches || t.machesSelector || t.mozMatchesSelector || t.msMatchesSelector || t.oMatchesSelector || t.webkitMatchesSelector || function(t) {
            return -1 < Array.prototype.indexOf.call(this.parentElement.querySelectorAll(t), this)
        }, Object.keys || (Object.keys = (o = Object.prototype.hasOwnProperty, n = [], a = !{
            toString: null
        }.propertyIsEnumerable("toString"), r = (n = ["toString", "toLocaleString", "valueOf", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "constructor"]).length, function(t) {
            var e = [],
                i = "",
                s = -1;
            ...
            if (a)
                for (s = 0; s < r; s++) o.call(t, n[s]) && e.push(n[s]);
            return e
            ...
            l.prototype = t || {};
            var i = new l;
            return l.prototype = null, void 0 !== e && Object.defineProperties(i, e), null === t && (i.__proto__ = null), i
        }), String.prototype.trim || (String.prototype.trim = function() {
            return this.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")
        }), Array.prototype.indexOf || (Array.prototype.indexOf = function(t) {
            var e, i, s, o;
            if (null === this) throw new TypeError;
            if (0 == (o = (s = Object(this)).length >>> 0)) return -1;
            if (e = 0, 1 < arguments.length && ((e = Number(arguments[1])) != e ? e = 0 : 0 !== e && e !== 1 / 0 && e !== -1 / 0 && (e = (0 < e || -1) * Math.floor(Math.abs(e)))), o <= e) return -1;
            for (i = 0 <= e ? e : Math.max(o - Math.abs(e), 0); i < o; i++)
                if (i in s && s[i] === t) return i;
            return -1
        }), Function.prototype.bind || (Function.prototype.bind = function(t) {
            var e, i, s, o;
            if ("function" != typeof this) throw new TypeError;
            return e = Array.prototype.slice.call(arguments, 1), s = function() {}, o = function() {
                return i.apply(this instanceof s ? this : t, e.concat(Array.prototype.slice.call(arguments)))
            }, (i = this).prototype && (s.prototype = this.prototype), o.prototype = new s, o
        ...
        var s, o = null,
            ...
            d = -1,
            r = i || p.document;
        if ((n = arguments[3]) && (n = "boolean" == typeof n), "string" == typeof t) h = r.querySelectorAll(t);
        else if (t && "object" == typeof t && f.isElement(t, r)) h = [t];
        else {
            if (!t || "object" != typeof t || !t.length) throw new Error(u.messages.errorFactoryInvalidContainer());
            h = t
        }
        if (h.length < 1) throw new Error(u.messages.errorFactoryContainerNotFound());
        for (d = 0;
            (o = h[d]) && (!(0 < d) || n); d++) o.id ? c = o.id : (c = "MixItUp" + f.randomHex(), o.id = c), u.instances[c] instanceof u.Mixer ? (a = u.instances[c], (!e || e && e.debug && !1 !== e.debug.showWarnings) && console.warn(u.messages.warningFactoryPreexistingInstance())) : ((a = new u.Mixer).attach(o, r, c, e), u.instances[c] = a), s = new u.Facade(a), e && e.debug && e.debug.enable ? l.push(a) : l.push(s);
        return n ? new u.Collection(l) : l[0]
    }).use = function(t) {
        u.Base.prototype.callActions.call(u, "beforeUse", arguments), "function" == typeof t && "mixitup-extension" === t.TYPE ? void 0 === u.extensions[t.NAME] && (t(u), u.extensions[t.NAME] = t) : t.fn && t.fn.jquery && (u.libraries.$ = t), u.Base.prototype.callActions.call(u, "afterUse", arguments)
    }, u.instances = {}, u.extensions = {}, u.libraries = {}, f = {
        ...
        removeClass: function(t, e) {
            var i;
            this.hasClass(t, e) && (i = new RegExp("(\\s|^)" + e + "(\\s|$)"), t.className = t.className.replace(i, " ").trim())
        },
        extend: function(e, t, i, s) {
            ...
            try {
                if (Array.isArray(t))
                    for (a = 0; a < t.length; a++) n.push(a);
                else t && (n = Object.keys(t));
                for (a = 0; a < n.length; a++) o = n[a], !i || "object" != typeof t[o] || this.isElement(t[o]) ? e[o] = t[o] : (Array.isArray(t[o]) ? e[o] || (e[o] = []) : e[o] || (e[o] = {}), this.extend(e[o], t[o], i, s))
            } catch (t) {
                if (!s) throw t;
        ...
        handleExtendError: function(t, e) {
            var i, s = null,
                ...
                l = -1,
                c = -1;
            if (t instanceof TypeError && (s = /property "?(\w*)"?[,:] object/i.exec(t.message))) {
                for (r in o = s[1], e) {
                ...
                throw 1 < l && (n = u.messages.errorConfigInvalidPropertySuggestion({
                    probableMatch: a
                })), i = u.messages.errorConfigInvalidProperty({
                    erroneous: o,
                    suggestion: n
                }), new TypeError(i)
            }
        ...
        template: function(s) {
            for (var t, e = /\${([\w]*)}/g, o = {}; t = e.exec(s);) o[t[1]] = new RegExp("\\${" + t[1] + "}", "g");
            return function(t) {
                var e = "",
                    i = s;
                for (e in t = t || {}, o) i = i.replace(o[e], void 0 !== t[e] ? t[e] : "");
                return i
            }
        },
        on: function(t, e, i, s) {
            t && (t.addEventListener ? t.addEventListener(e, i, s) : t.attachEvent && (t["e" + e + i] = i, t[e + i] = function() {
                t["e" + e + i](p.event)
        ...
        getCustomEvent: function(t, e, i) {
            var s = null;
            return i = i || p.document, "function" == typeof p.CustomEvent ? s = new p.CustomEvent(t, {
                detail: e,
                bubbles: !0,
                cancelable: !0
            }) : "function" == typeof i.createEvent ? (s = i.createEvent("CustomEvent")).initCustomEvent(t, !0, !0, e) : ((s = i.createEventObject()).type = t, s.returnValue = !1, s.cancelBubble = !1, s.detail = e), s
        },
        ...
        isElement: function(t, e) {
            return e = e || p.document, !!(p.HTMLElement && t instanceof p.HTMLElement) || (!!(e.defaultView && e.defaultView.HTMLElement && t instanceof e.defaultView.HTMLElement) || null !== t && 1 === t.nodeType && "string" == typeof t.nodeName)
        },
        createElement: function(t, e) {
            var i = null,
                s = null,
                i = (e = e || p.document).createDocumentFragment();
            for ((s = e.createElement("div")).innerHTML = t.trim(); s.firstChild;) i.appendChild(s.firstChild);
            return i
        },
        ...
        arrayShuffle: function(t) {
            for (var e, i, s = t.slice(), o = s.length, n = o; n--;) e = ~~(Math.random() * o), i = s[n], s[n] = s[e], s[e] = i;
            return s
        },
        arrayFromList: function(e) {
            ...
            try {
                ...
                for (i = [], s = 0; s < e.length; s++) i.push(e[s]);
                return i
            }
        },
        debounce: function(o, n, a) {
            var r;
            return function() {
                var t = this,
                    e = arguments,
                    i = a && !r,
                    s = function() {
                        r = null, a || o.apply(t, e)
                    };
                clearTimeout(r), r = setTimeout(s, n), i && o.apply(t, e)
            }
        },
        position: function(t) {
            for (var e = 0, i = 0, s = t; t;) e -= t.scrollLeft, i -= t.scrollTop, t === s && (e += t.offsetLeft, i += t.offsetTop, s = t.offsetParent), t = t.parentElement;
            return {
                x: e,
                y: i
            }
        ...
        getIntersectionRatio: function(t, e) {
            var i = t.width * t.height,
                s = Math.max(0, Math.min(t.left + t.width, e.left + e.width) - Math.max(t.left, e.left));
            return Math.max(0, Math.min(t.top + t.height, e.top + e.height) - Math.max(t.top, e.top)) * s / i
        },
        closestParent: function(t, e, i, s) {
            var o = t.parentNode;
            if (s = s || p.document, i && t.matches(e)) return t;
            for (; o && o != s.body;) {
                if (o.matches && o.matches(e)) return o;
        ...
        children: function(t, e, i) {
            var s = [],
                o = "";
            return i = i || p.doc, t && (t.id || (o = "Temp" + this.randomHexKey(), t.id = o), s = i.querySelectorAll("#" + t.id + " > " + e), o && t.removeAttribute("id")), s
        },
        clean: function(t) {
        ...
        defer: function(t) {
            var e = null,
                ...
                s = null,
                i = new this.Deferred;
            return u.features.has.promises ? i.promise = new Promise(function(t, e) {
                i.resolve = t, i.reject = e
            }) : (s = p.jQuery || t.$) && "function" == typeof s.Deferred ? (e = s.Deferred(), i.promise = e.promise(), i.resolve = e.resolve, i.reject = e.reject) : p.console && console.warn(u.messages.warningNoPromiseImplementation()), i
        },
        all: function(t, e) {
            var i = null;
        ...
        compareVersions: function(t, e) {
            for (var i, s, o = t.split("."), n = e.split("."), a = -1, a = 0; a < o.length; a++) {
                if (i = parseInt(o[a].replace(/[^\d.]/g, "")), (s = parseInt(n[a].replace(/[^\d.]/g, "") || 0)) < i) return !1;
                if (i < s) return !0
            }
            return !0
        },
        Deferred: function() {
            this.promise = null, this.resolve = null, this.reject = null, this.id = f.randomHex()
        },
        ...
        getClassname: function(t, e, i) {
            var s = "";
            return (s += t.block).length && (s += t.delineatorElement), s += t["element" + this.pascalCase(e)], i ? (s.length && (s += t.delineatorModifier), s += i) : s
        },
        getProperty: function(t, e) {
            ...
            for (i = function(t) {
                    return t ? t[o] : null
                }; n < s.length;) o = s[n], t = i(t), n++;
            return void 0 !== t ? t : null
        }
    }, u.h = f, u.Base = function() {}, u.Base.prototype = {
        constructor: u.Base,
        callActions: function(t, e) {
            var i = this.constructor.actions[t],
                s = "";
            if (i && !f.isEmptyObject(i))
                for (s in i) i[s].apply(this, e)
        },
        callFilters: function(t, e, i) {
            var s = this.constructor.filters[t],
                o = e,
                n = "";
            if (!s || f.isEmptyObject(s)) return o;
            for (n in i = i || [], s)(i = f.arrayFromList(i)).unshift(o), o = s[n].apply(this, i);
            return o
        }
        ...
        runTests: function() {
            var t = this;
            t.callActions("beforeRunTests", arguments), t.has.promises = "function" == typeof p.Promise, t.has.transitions = "unsupported" !== t.transitionPrefix, t.callActions("afterRunTests", arguments), f.freeze(t.has)
        },
        ...
        this.transitions = !1, this.promises = !1, f.seal(this)
    }, u.features = new u.Features, u.features.init(), u.ConfigAnimation = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.enable = !0, this.effects = "fade scale", this.effectsIn = "", this.effectsOut = "", this.duration = 600, this.easing = "ease", this.applyPerspective = !0, this.perspectiveDistance = "3000px", this.perspectiveOrigin = "50% 50%", this.queue = !0, this.queueLimit = 3, this.animateResizeContainer = !0, this.animateResizeTargets = !1, this.staggerSequence = null, this.reverseOut = !1, this.nudge = !0, this.clampHeight = !0, this.clampWidth = !0, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigAnimation), u.ConfigAnimation.prototype = Object.create(u.Base.prototype), u.ConfigAnimation.prototype.constructor = u.ConfigAnimation, u.ConfigBehavior = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.liveSort = !1, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigBehavior), u.ConfigBehavior.prototype = Object.create(u.Base.prototype), u.ConfigBehavior.prototype.constructor = u.ConfigBehavior, u.ConfigCallbacks = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.onMixStart = null, this.onMixBusy = null, this.onMixEnd = null, this.onMixFail = null, this.onMixClick = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigCallbacks), u.ConfigCallbacks.prototype = Object.create(u.Base.prototype), u.ConfigCallbacks.prototype.constructor = u.ConfigCallbacks, u.ConfigControls = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.enable = !0, this.live = !1, this.scope = "global", this.toggleLogic = "or", this.toggleDefault = "all", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigControls), u.ConfigControls.prototype = Object.create(u.Base.prototype), u.ConfigControls.prototype.constructor = u.ConfigControls, u.ConfigClassNames = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.block = "mixitup", this.elementContainer = "container", this.elementFilter = "control", this.elementSort = "control", this.elementMultimix = "control", this.elementToggle = "control", this.modifierActive = "active", this.modifierDisabled = "disabled", this.modifierFailed = "failed", this.delineatorElement = "-", this.delineatorModifier = "-", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigClassNames), u.ConfigClassNames.prototype = Object.create(u.Base.prototype), u.ConfigClassNames.prototype.constructor = u.ConfigClassNames, u.ConfigData = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.uidKey = "", this.dirtyCheck = !1, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigData), u.ConfigData.prototype = Object.create(u.Base.prototype), u.ConfigData.prototype.constructor = u.ConfigData, u.ConfigDebug = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.enable = !1, this.showWarnings = !0, this.fauxAsync = !1, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigDebug), u.ConfigDebug.prototype = Object.create(u.Base.prototype), u.ConfigDebug.prototype.constructor = u.ConfigDebug, u.ConfigLayout = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.allowNestedTargets = !0, this.containerClassName = "", this.siblingBefore = null, this.siblingAfter = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigLayout), u.ConfigLayout.prototype = Object.create(u.Base.prototype), u.ConfigLayout.prototype.constructor = u.ConfigLayout, u.ConfigLoad = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.filter = "all", this.sort = "default:asc", this.dataset = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigLoad), u.ConfigLoad.prototype = Object.create(u.Base.prototype), u.ConfigLoad.prototype.constructor = u.ConfigLoad, u.ConfigSelectors = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.target = ".mix", this.control = "", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigSelectors), u.ConfigSelectors.prototype = Object.create(u.Base.prototype), u.ConfigSelectors.prototype.constructor = u.ConfigSelectors, u.ConfigRender = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.target = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigRender), u.ConfigRender.prototype = Object.create(u.Base.prototype), u.ConfigRender.prototype.constructor = u.ConfigRender, u.ConfigTemplates = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.ConfigTemplates), u.ConfigTemplates.prototype = Object.create(u.Base.prototype), u.ConfigTemplates.prototype.constructor = u.ConfigTemplates, u.Config = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.animation = new u.ConfigAnimation, this.behavior = new u.ConfigBehavior, this.callbacks = new u.ConfigCallbacks, this.controls = new u.ConfigControls, this.classNames = new u.ConfigClassNames, this.data = new u.ConfigData, this.debug = new u.ConfigDebug, this.layout = new u.ConfigLayout, this.load = new u.ConfigLoad, this.selectors = new u.ConfigSelectors, this.render = new u.ConfigRender, this.templates = new u.ConfigTemplates, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Config), u.Config.prototype = Object.create(u.Base.prototype), u.Config.prototype.constructor = u.Config, u.MixerDom = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.document = null, this.body = null, this.container = null, this.parent = null, this.targets = [], this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.MixerDom), u.MixerDom.prototype = Object.create(u.Base.prototype), u.MixerDom.prototype.constructor = u.MixerDom, u.UiClassNames = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.base = "", this.active = "", this.disabled = "", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.UiClassNames), u.UiClassNames.prototype = Object.create(u.Base.prototype), u.UiClassNames.prototype.constructor = u.UiClassNames, u.CommandDataset = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.dataset = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandDataset), u.CommandDataset.prototype = Object.create(u.Base.prototype), u.CommandDataset.prototype.constructor = u.CommandDataset, u.CommandMultimix = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.filter = null, this.sort = null, this.insert = null, this.remove = null, this.changeLayout = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandMultimix), u.CommandMultimix.prototype = Object.create(u.Base.prototype), u.CommandMultimix.prototype.constructor = u.CommandMultimix, u.CommandFilter = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.selector = "", this.collection = null, this.action = "show", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandFilter), u.CommandFilter.prototype = Object.create(u.Base.prototype), u.CommandFilter.prototype.constructor = u.CommandFilter, u.CommandSort = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.sortString = "", this.attribute = "", this.order = "asc", this.collection = null, this.next = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandSort), u.CommandSort.prototype = Object.create(u.Base.prototype), u.CommandSort.prototype.constructor = u.CommandSort, u.CommandInsert = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.index = 0, this.collection = [], this.position = "before", this.sibling = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandInsert), u.CommandInsert.prototype = Object.create(u.Base.prototype), u.CommandInsert.prototype.constructor = u.CommandInsert, u.CommandRemove = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.targets = [], this.collection = [], this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandRemove), u.CommandRemove.prototype = Object.create(u.Base.prototype), u.CommandRemove.prototype.constructor = u.CommandRemove, u.CommandChangeLayout = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.containerClassName = "", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.CommandChangeLayout), u.CommandChangeLayout.prototype = Object.create(u.Base.prototype), u.CommandChangeLayout.prototype.constructor = u.CommandChangeLayout, u.ControlDefinition = function(t, e, i, s) {
        u.Base.call(this), this.callActions("beforeConstruct"), this.type = t, this.selector = e, this.live = i || !1, this.parent = s || "", this.callActions("afterConstruct"), f.freeze(this), f.seal(this)
    }, u.BaseStatic.call(u.ControlDefinition), u.ControlDefinition.prototype = Object.create(u.Base.prototype), u.ControlDefinition.prototype.constructor = u.ControlDefinition, u.controlDefinitions = [], u.controlDefinitions.push(new u.ControlDefinition("multimix", "[data-filter][data-sort]")), u.controlDefinitions.push(new u.ControlDefinition("filter", "[data-filter]")), u.controlDefinitions.push(new u.ControlDefinition("sort", "[data-sort]")), u.controlDefinitions.push(new u.ControlDefinition("toggle", "[data-toggle]")), u.Control = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.el = null, this.selector = "", this.bound = [], this.pending = -1, this.type = "", this.status = "inactive", this.filter = "", this.sort = "", this.canDisable = !1, this.handler = null, this.classNames = new u.UiClassNames, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Control), u.Control.prototype = Object.create(u.Base.prototype), f.extend(u.Control.prototype, {
        constructor: u.Control,
        init: function(t, e, i) {
            var s = this;
            if (this.callActions("beforeInit", arguments), s.el = t, s.type = e, s.selector = i, s.selector) s.status = "live";
            ...
            s.bindClick(), u.controls.push(s), this.callActions("afterInit", arguments)
        },
        isBound: function(t) {
            var e;
        ...
        removeBinding: function(t) {
            var e = this,
                i = -1;
            this.callActions("beforeRemoveBinding", arguments), -1 < (i = e.bound.indexOf(t)) && e.bound.splice(i, 1), e.bound.length < 1 && (e.unbindClick(), i = u.controls.indexOf(e), u.controls.splice(i, 1), "active" === e.status && e.renderStatus(e.el, "inactive")), this.callActions("afterRemoveBinding", arguments)
        },
        bindClick: function() {
            var e = this;
            this.callActions("beforeBindClick", arguments), e.handler = function(t) {
                e.handleClick(t)
            }, f.on(e.el, "click", e.handler), this.callActions("afterBindClick", arguments)
        },
        unbindClick: function() {
            this.callActions("beforeUnbindClick", arguments), f.off(this.el, "click", this.handler), this.handler = null, this.callActions("afterUnbindClick", arguments)
        },
        handleClick: function(t) {
            var e, i = this,
                ...
                r = [],
                l = -1;
            if (this.callActions("beforeHandleClick", arguments), this.pending = 0, o = i.bound[0], s = i.selector ? f.closestParent(t.target, o.config.selectors.control + i.selector, !0, o.dom.document) : i.el) {
                switch (i.type) {
                    case "filter":
                        a.filter = i.filter || s.getAttribute("data-filter");
                        break;
                    case "sort":
                        a.sort = i.sort || s.getAttribute("data-sort");
                        break;
                    case "multimix":
                        a.filter = i.filter || s.getAttribute("data-filter"), a.sort = i.sort || s.getAttribute("data-sort");
                        break;
                    case "toggle":
                        a.filter = i.filter || s.getAttribute("data-toggle"), n = "live" === i.status ? f.hasClass(s, i.classNames.active) : "active" === i.status
                }
                for (l = 0; l < i.bound.length; l++) e = new u.CommandMultimix, f.extend(e, a), r.push(e);
                for (r = i.callFilters("commandsHandleClick", r, arguments), i.pending = i.bound.length, l = 0; o = i.bound[l]; l++)(a = r[l]) && (o.lastClicked || (o.lastClicked = s), u.events.fire("mixClick", o.dom.container, {
                    state: o.state,
                    instance: o,
                    originalEvent: t,
                    control: o.lastClicked
                }, o.dom.document), "function" == typeof o.config.callbacks.onMixClick && !1 === o.config.callbacks.onMixClick.call(o.lastClicked, o.state, t, o) || ("toggle" === i.type ? n ? o.toggleOff(a.filter) : o.toggleOn(a.filter) : o.multimix(a)));
                this.callActions("afterHandleClick", arguments)
            } else i.callActions("afterHandleClick", arguments)
        },
        update: function(t, e) {
            var i = this,
                s = new u.CommandMultimix;
            i.callActions("beforeUpdate", arguments), i.pending--, i.pending = Math.max(0, i.pending), 0 < i.pending || ("live" === i.status ? i.updateLive(t, e) : (s.sort = i.sort, s.filter = i.filter, i.callFilters("actionsUpdate", s, arguments), i.parseStatusChange(i.el, t, s, e)), i.callActions("afterUpdate", arguments))
        },
        updateLive: function(t, e) {
            var i, s = this,
                ...
                n = null,
                a = -1;
            if (s.callActions("beforeUpdateLive", arguments), s.el) {
                for (i = s.el.querySelectorAll(s.selector), a = 0; n = i[a]; a++) {
                    switch (o = new u.CommandMultimix, s.type) {
                        case "filter":
                            o.filter = n.getAttribute("data-filter");
                            break;
                        case "sort":
                            o.sort = n.getAttribute("data-sort");
                            break;
                        case "multimix":
                            o.filter = n.getAttribute("data-filter"), o.sort = n.getAttribute("data-sort");
                            break;
                        case "toggle":
                            o.filter = n.getAttribute("data-toggle")
                    }
                    o = s.callFilters("actionsUpdateLive", o, arguments), s.parseStatusChange(n, t, o, e)
                }
                s.callActions("afterUpdateLive", arguments)
            }
        },
        parseStatusChange: function(t, e, i, s) {
            var o = this,
                n = "",
                a = -1;
            switch (o.callActions("beforeParseStatusChange", arguments), o.type) {
                ...
                case "multimix":
                    ...
                    break;
                case "sort":
                    e.sort.match(/:asc/g) && (n = e.sort.replace(/:asc/g, "")), e.sort === i.sort || n === i.sort ? o.renderStatus(t, "active") : o.renderStatus(t, "inactive");
                    break;
                case "toggle":
                    for (s.length < 1 && o.renderStatus(t, "inactive"), e.filter === i.filter && o.renderStatus(t, "active"), a = 0; a < s.length; a++) {
                        if (s[a] === i.filter) {
        ...
        renderStatus: function(t, e) {
            ...
            switch (i.callActions("beforeRenderStatus", arguments), e) {
                case "active":
                    f.addClass(t, i.classNames.active), f.removeClass(t, i.classNames.disabled), i.canDisable && (i.el.disabled = !1);
                    break;
                case "inactive":
                    f.removeClass(t, i.classNames.active), f.removeClass(t, i.classNames.disabled), i.canDisable && (i.el.disabled = !1);
                    break;
                case "disabled":
                    i.canDisable && (i.el.disabled = !0), f.addClass(t, i.classNames.disabled), f.removeClass(t, i.classNames.active)
            }
            "live" !== i.status && (i.status = e), i.callActions("afterRenderStatus", arguments)
        }
    }), u.controls = [], u.StyleData = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.x = 0, this.y = 0, this.top = 0, this.right = 0, this.bottom = 0, this.left = 0, this.width = 0, this.height = 0, this.marginRight = 0, this.marginBottom = 0, this.opacity = 0, this.scale = new u.TransformData, this.translateX = new u.TransformData, this.translateY = new u.TransformData, this.translateZ = new u.TransformData, this.rotateX = new u.TransformData, this.rotateY = new u.TransformData, this.rotateZ = new u.TransformData, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.StyleData), u.StyleData.prototype = Object.create(u.Base.prototype), u.StyleData.prototype.constructor = u.StyleData, u.TransformData = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.value = 0, this.unit = "", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.TransformData), u.TransformData.prototype = Object.create(u.Base.prototype), u.TransformData.prototype.constructor = u.TransformData, u.TransformDefaults = function() {
        u.StyleData.apply(this), this.callActions("beforeConstruct"), this.scale.value = .01, this.scale.unit = "", this.translateX.value = 20, this.translateX.unit = "px", this.translateY.value = 20, this.translateY.unit = "px", this.translateZ.value = 20, this.translateZ.unit = "px", this.rotateX.value = 90, this.rotateX.unit = "deg", this.rotateY.value = 90, this.rotateY.unit = "deg", this.rotateX.value = 90, this.rotateX.unit = "deg", this.rotateZ.value = 180, this.rotateZ.unit = "deg", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.TransformDefaults), u.TransformDefaults.prototype = Object.create(u.StyleData.prototype), u.TransformDefaults.prototype.constructor = u.TransformDefaults, u.transformDefaults = new u.TransformDefaults, u.EventDetail = function() {
        this.state = null, this.futureState = null, this.instance = null, this.originalEvent = null
    }, u.Events = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.mixStart = null, this.mixBusy = null, this.mixEnd = null, this.mixFail = null, this.mixClick = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Events), u.Events.prototype = Object.create(u.Base.prototype), u.Events.prototype.constructor = u.Events, u.Events.prototype.fire = function(t, e, i, s) {
        var o, n = new u.EventDetail;
        if (this.callActions("beforeFire", arguments), void 0 === this[t]) throw new Error('Event type "' + t + '" not found.');
        n.state = new u.State, f.extend(n.state, i.state), i.futureState && (n.futureState = new u.State, f.extend(n.futureState, i.futureState)), n.instance = i.instance, i.originalEvent && (n.originalEvent = i.originalEvent), o = f.getCustomEvent(t, n, s), this.callFilters("eventFire", o, arguments), e.dispatchEvent(o)
    }, u.events = new u.Events, u.QueueItem = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.args = [], this.instruction = null, this.triggerElement = null, this.deferred = null, this.isToggling = !1, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.QueueItem), u.QueueItem.prototype = Object.create(u.Base.prototype), u.QueueItem.prototype.constructor = u.QueueItem, u.Mixer = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.config = new u.Config, this.id = "", this.isBusy = !1, this.isToggling = !1, this.incPadding = !0, this.controls = [], this.targets = [], this.origOrder = [], this.cache = {}, this.toggleArray = [], this.targetsMoved = 0, this.targetsImmovable = 0, this.targetsBound = 0, this.targetsDone = 0, this.staggerDuration = 0, this.effectsIn = null, this.effectsOut = null, this.transformIn = [], this.transformOut = [], this.queue = [], this.state = null, this.lastOperation = null, this.lastClicked = null, this.userCallback = null, this.userDeferred = null, this.dom = new u.MixerDom, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Mixer), u.Mixer.prototype = Object.create(u.Base.prototype), f.extend(u.Mixer.prototype, {
        constructor: u.Mixer,
        attach: function(t, e, i, s) {
            var o = this,
                n = null,
                a = -1;
            for (o.callActions("beforeAttach", arguments), o.id = i, s && f.extend(o.config, s, !0, !0), o.sanitizeConfig(), o.cacheDom(t, e), o.config.layout.containerClassName && f.addClass(o.dom.container, o.config.layout.containerClassName), u.features.has.transitions || (o.config.animation.enable = !1), void 0 === p.console && (o.config.debug.showWarnings = !1), o.config.data.uidKey && (o.config.controls.enable = !1), o.indexTargets(), o.state = o.getInitialState(), a = 0; n = o.lastOperation.toHide[a]; a++) n.hide();
            o.config.controls.enable && (o.initControls(), o.buildToggleArray(null, o.state), o.updateControls({
                filter: o.state.activeFilter,
                sort: o.state.activeSort
            })), o.parseEffects(), o.callActions("afterAttach", arguments)
        },
        ...
        indexTargets: function() {
            var t, e, i = this,
                s = null,
                o = -1;
            if (i.callActions("beforeIndexTargets", arguments), i.dom.targets = i.config.layout.allowNestedTargets ? i.dom.container.querySelectorAll(i.config.selectors.target) : f.children(i.dom.container, i.config.selectors.target, i.dom.document), i.dom.targets = f.arrayFromList(i.dom.targets), i.targets = [], (e = i.config.load.dataset) && e.length !== i.dom.targets.length) throw new Error(u.messages.errorDatasetPrerenderedMismatch());
            if (i.dom.targets.length) {
                for (o = 0; t = i.dom.targets[o]; o++)(s = new u.Target).init(t, i, e ? e[o] : void 0), s.isInDom = !0, i.targets.push(s);
        ...
        initControls: function() {
            ...
            for (r = 0; t = u.controlDefinitions[r]; r++)
                if (i.config.controls.live || t.live) {
                    if (t.parent) {
                        if (!(n = i.dom[t.parent]) || n.length < 0) continue;
                        "number" != typeof n.length && (n = [n])
                    } else n = [o];
                    for (l = 0; s = n[l]; l++) a = i.getControl(s, t.type, t.selector), i.controls.push(a)
                } else
                    for (e = o.querySelectorAll(i.config.selectors.control + t.selector), l = 0; s = e[l]; l++)(a = i.getControl(s, t.type, "")) && i.controls.push(a);
        ...
        getControl: function(t, e, i) {
            var s = this,
                o = null,
                n = -1;
            if (s.callActions("beforeGetControl", arguments), !i)
                for (n = 0; o = u.controls[n]; n++) {
                    if (o.el === t && o.isBound(s)) return s.callFilters("controlGetControl", null, arguments);
                    if (o.el === t && o.type === e && o.selector === i) return o.addBinding(s), s.callFilters("controlGetControl", o, arguments)
                }
            return (o = new u.Control).init(t, e, i), o.classNames.base = f.getClassname(s.config.classNames, e), o.classNames.active = f.getClassname(s.config.classNames, e, s.config.classNames.modifierActive), o.classNames.disabled = f.getClassname(s.config.classNames, e, s.config.classNames.modifierDisabled), o.addBinding(s), s.callFilters("controlGetControl", o, arguments)
        },
        getToggleSelector: function() {
            var t = this,
                e = "or" === t.config.controls.toggleLogic ? ", " : "",
                i = "";
            return t.callActions("beforeGetToggleSelector", arguments), t.toggleArray = f.clean(t.toggleArray), "" === (i = t.toggleArray.join(e)) && (i = t.config.controls.toggleDefault), t.callFilters("selectorGetToggleSelector", i, arguments)
        },
        buildToggleArray: function(t, e) {
            var i = this,
                s = "";
            if (i.callActions("beforeBuildToggleArray", arguments), t && t.filter) s = t.filter.selector.replace(/\s/g, "");
            else {
                if (!e) return;
                s = e.activeFilter.selector.replace(/\s/g, "")
            }
            s !== i.config.selectors.target && "all" !== s || (s = ""), "or" === i.config.controls.toggleLogic ? i.toggleArray = s.split(",") : i.toggleArray = i.splitCompoundSelector(s), i.toggleArray = f.clean(i.toggleArray), i.callActions("afterBuildToggleArray", arguments)
        },
        splitCompoundSelector: function(t) {
            var e = t.split(/([\.\[])/g),
                ...
                s = "",
                o = -1;
            for ("" === e[0] && e.shift(), o = 0; o < e.length; o++) o % 2 == 0 && (s = ""), s += e[o], o % 2 != 0 && i.push(s);
            return i
        },
        updateControls: function(t) {
            var e = this,
                ...
                s = new u.CommandMultimix,
                o = -1;
            for (e.callActions("beforeUpdateControls", arguments), t.filter ? s.filter = t.filter.selector : s.filter = e.state.activeFilter.selector, t.sort ? s.sort = e.buildSortString(t.sort) : s.sort = e.buildSortString(e.state.activeSort), s.filter === e.config.selectors.target && (s.filter = "all"), "" === s.filter && (s.filter = "none"), f.freeze(s), o = 0; i = e.controls[o]; o++) i.update(s, e.toggleArray);
        ...
        insertTargets: function(t, e) {
            var i, s = this,
                ...
                r = null,
                l = -1;
            if (s.callActions("beforeInsertTargets", arguments), void 0 === t.index && (t.index = 0), i = s.getNextSibling(t.index, t.sibling, t.position), n = s.dom.document.createDocumentFragment(), o = i ? f.index(i, s.config.selectors.target) : s.targets.length, t.collection) {
                for (l = 0; r = t.collection[l]; l++) {
                    if (-1 < s.dom.targets.indexOf(r)) throw new Error(u.messages.errorInsertPreexistingElement());
                    r.style.display = "none", n.appendChild(r), n.appendChild(s.dom.document.createTextNode(" ")), f.isElement(r, s.dom.document) && r.matches(s.config.selectors.target) && ((a = new u.Target).init(r, s), a.isInDom = !0, s.targets.splice(o, 0, a), o++)
                }
                s.dom.parent.insertBefore(n, i)
            }
            e.startOrder = s.origOrder = s.targets, s.callActions("afterInsertTargets", arguments)
        },
        getNextSibling: function(t, e, i) {
            var s = this,
                o = null;
            return t = Math.max(t, 0), e && "before" === i ? o = e : e && "after" === i ? o = e.nextElementSibling || null : 0 < s.targets.length && void 0 !== t ? o = t < s.targets.length || !s.targets.length ? s.targets[t].dom.el : s.targets[s.targets.length - 1].dom.el.nextElementSibling : 0 === s.targets.length && 0 < s.dom.parent.children.length && (s.config.layout.siblingAfter ? o = s.config.layout.siblingAfter : s.config.layout.siblingBefore ? o = s.config.layout.siblingBefore.nextElementSibling : s.dom.parent.children[0]), s.callFilters("elementGetNextSibling", o, arguments)
        },
        filterOperation: function(t) {
            var e, i, s = !1,
                o = null,
                n = -1;
            for (this.callActions("beforeFilterOperation", arguments), i = t.newFilter.action, n = 0; o = t.newOrder[n]; n++) s = t.newFilter.collection ? -1 < t.newFilter.collection.indexOf(o.dom.el) : "" !== t.newFilter.selector && o.dom.el.matches(t.newFilter.selector), this.evaluateHideShow(s, o, i, t);
            if (t.toRemove.length)
                for (n = 0; o = t.show[n]; n++) - 1 < t.toRemove.indexOf(o) && (t.show.splice(n, 1), -1 < (e = t.toShow.indexOf(o)) && t.toShow.splice(e, 1), t.toHide.push(o), t.hide.push(o), n--);
        ...
        evaluateHideShow: function(t, e, i, s) {
            var o = Array.prototype.slice.call(arguments, 1),
                n = this.callFilters("testResultEvaluateHideShow", t, o);
            this.callActions("beforeEvaluateHideShow", arguments), !0 === n && "show" === i || !1 === n && "hide" === i ? (s.show.push(e), e.isShown || s.toShow.push(e)) : (s.hide.push(e), e.isShown && s.toHide.push(e)), this.callActions("afterEvaluateHideShow", arguments)
        },
        sortOperation: function(i) {
            var t, s = this,
                ...
                o = null,
                n = -1;
            if (s.callActions("beforeSortOperation", arguments), i.startOrder = s.targets, i.newSort.collection) {
                for (e = [], n = 0; t = i.newSort.collection[n]; n++) {
                    if (s.dom.targets.indexOf(t) < 0) throw new Error(u.messages.errorSortNonExistentElement());
                    (o = new u.Target).init(t, s), o.isInDom = !0, e.push(o)
                }
                i.newOrder = e
            } else "random" === i.newSort.order ? i.newOrder = f.arrayShuffle(i.startOrder) : "" === i.newSort.attribute ? (i.newOrder = s.origOrder.slice(), "desc" === i.newSort.order && i.newOrder.reverse()) : (i.newOrder = i.startOrder.slice(), i.newOrder.sort(function(t, e) {
                return s.compare(t, e, i.newSort)
            }));
            f.isEqualArray(i.newOrder, i.startOrder) && (i.willSort = !1), s.callActions("afterSortOperation", arguments)
        },
        compare: function(t, e, i) {
            var s = i.order,
                o = this.getAttributeValue(t, i.attribute),
                n = this.getAttributeValue(e, i.attribute),
                n = isNaN(+o) || isNaN(+n) ? (o = o.toLowerCase(), n.toLowerCase()) : (o = +o, +n);
            return o < n ? "asc" === s ? -1 : 1 : n < o ? "asc" === s ? 1 : -1 : o === n && i.next ? this.compare(t, e, i.next) : 0
        },
        ...
        printSort: function(t, e) {
            var i, s = this,
                o = t ? e.newOrder : e.startOrder,
                n = t ? e.startOrder : e.newOrder,
                a = o.length ? o[o.length - 1].dom.el.nextElementSibling : null,
                r = p.document.createDocumentFragment(),
                l = null,
                c = null,
                h = -1;
            for (s.callActions("beforePrintSort", arguments), h = 0; l = o[h]; h++) "absolute" !== (c = l.dom.el).style.position && (f.removeWhitespace(c.previousSibling), c.parentElement.removeChild(c));
            for ((i = a ? a.previousSibling : s.dom.parent.lastChild) && "#text" === i.nodeName && f.removeWhitespace(i), h = 0; l = n[h]; h++) c = l.dom.el, f.isElement(r.lastChild) && r.appendChild(p.document.createTextNode(" ")), r.appendChild(c);
            s.dom.parent.firstChild && s.dom.parent.firstChild !== a && r.insertBefore(p.document.createTextNode(" "), r.childNodes[0]), a ? (r.appendChild(p.document.createTextNode(" ")), s.dom.parent.insertBefore(r, a)) : s.dom.parent.appendChild(r), s.callActions("afterPrintSort", arguments)
        },
        parseSortString: function(t, e) {
            for (var i, s = t.split(" "), o = e, n = -1, n = 0; n < s.length; n++) {
                switch (i = s[n].split(":"), o.sortString = s[n], o.attribute = f.dashCase(i[0]), o.order = i[1] || "asc", o.attribute) {
                    case "default":
                        o.attribute = "";
                        break;
                    case "random":
                ...
                n < s.length - 1 && (o.next = new u.CommandSort, f.freeze(o), o = o.next)
            }
        ...
        parseEffects: function() {
            ...
            for (e in t.callActions("beforeParseEffects", arguments), t.effectsIn = new u.StyleData, t.effectsOut = new u.StyleData, t.transformIn = [], t.transformOut = [], t.effectsIn.opacity = t.effectsOut.opacity = 1, t.parseEffect("fade", i, t.effectsIn, t.transformIn), t.parseEffect("fade", s, t.effectsOut, t.transformOut, !0), u.transformDefaults) u.transformDefaults[e] instanceof u.TransformData && (t.parseEffect(e, i, t.effectsIn, t.transformIn), t.parseEffect(e, s, t.effectsOut, t.transformOut, !0));
            t.parseEffect("stagger", i, t.effectsIn, t.transformIn), t.parseEffect("stagger", s, t.effectsOut, t.transformOut, !0), t.callActions("afterParseEffects", arguments)
        },
        parseEffect: function(t, e, i, s, o) {
            var n, a, r, l = this,
                c = "",
                h = ["%", "px", "em", "rem", "vh", "vw", "deg"],
                d = -1;
            if (l.callActions("beforeParseEffect", arguments), "string" != typeof e) throw new TypeError(u.messages.errorConfigInvalidAnimationEffects());
            if (e.indexOf(t) < 0) "stagger" === t && (l.staggerDuration = 0);
            else {
                switch (-1 < (n = e.indexOf(t + "(")) && (a = e.substring(n), c = /\(([^)]+)\)/.exec(a)[1]), t) {
                    case "fade":
                    ...
                    case "stagger":
                        ...
                        break;
                    default:
                        if (o && l.config.animation.reverseOut && "scale" !== t ? i[t].value = -1 * (c ? parseFloat(c) : u.transformDefaults[t].value) : i[t].value = c ? parseFloat(c) : u.transformDefaults[t].value, c) {
                            for (d = 0; r = h[d]; d++)
                                if (-1 < c.indexOf(r)) {
                                    i[t].unit = r;
                                    break
        ...
        buildState: function(t) {
            var e = this,
                ...
                s = null,
                o = -1;
            for (e.callActions("beforeBuildState", arguments), o = 0; s = e.targets[o]; o++)(!t.toRemove.length || t.toRemove.indexOf(s) < 0) && i.targets.push(s.dom.el);
            for (o = 0; s = t.matching[o]; o++) i.matching.push(s.dom.el);
            for (o = 0; s = t.show[o]; o++) i.show.push(s.dom.el);
            for (o = 0; s = t.hide[o]; o++)(!t.toRemove.length || t.toRemove.indexOf(s) < 0) && i.hide.push(s.dom.el);
        ...
        goMix: function(t, e) {
            var i = this,
                s = null;
            return i.callActions("beforeGoMix", arguments), i.config.animation.duration && i.config.animation.effects && f.isVisible(i.dom.container) || (t = !1), e.toShow.length || e.toHide.length || e.willSort || e.willChangeLayout || (t = !1), e.startState.show.length || e.show.length || (t = !1), u.events.fire("mixStart", i.dom.container, {
                state: e.startState,
                futureState: e.newState,
                instance: i
            }, i.dom.document), "function" == typeof i.config.callbacks.onMixStart && i.config.callbacks.onMixStart.call(i.dom.container, e.startState, e.newState, i), f.removeClass(i.dom.container, f.getClassname(i.config.classNames, "container", i.config.classNames.modifierFailed)), s = i.userDeferred ? i.userDeferred : i.userDeferred = f.defer(u.libraries), i.isBusy = !0, t && u.features.has.transitions ? (p.pageYOffset !== e.docState.scrollTop && p.scrollTo(e.docState.scrollLeft, e.docState.scrollTop), i.config.animation.applyPerspective && (i.dom.parent.style[u.features.perspectiveProp] = i.config.animation.perspectiveDistance, i.dom.parent.style[u.features.perspectiveOriginProp] = i.config.animation.perspectiveOrigin), i.config.animation.animateResizeContainer && e.startHeight !== e.newHeight && e.viewportDeltaY !== e.startHeight - e.newHeight && (i.dom.parent.style.height = e.startHeight + "px"), i.config.animation.animateResizeContainer && e.startWidth !== e.newWidth && e.viewportDeltaX !== e.startWidth - e.newWidth && (i.dom.parent.style.width = e.startWidth + "px"), e.startHeight === e.newHeight && (i.dom.parent.style.height = e.startHeight + "px"), e.startWidth === e.newWidth && (i.dom.parent.style.width = e.startWidth + "px"), e.startHeight === e.newHeight && e.startWidth === e.newWidth && (i.dom.parent.style.overflow = "hidden"), requestAnimationFrame(function() {
                i.moveTargets(e)
            })) : i.config.debug.fauxAsync ? setTimeout(function() {
                i.cleanUp(e)
            }, i.config.animation.duration) : i.cleanUp(e), i.callFilters("promiseGoMix", s.promise, arguments)
        },
        getStartMixData: function(t) {
            var e = this,
                i = p.getComputedStyle(e.dom.parent),
                s = e.dom.parent.getBoundingClientRect(),
                o = null,
                n = {},
                a = -1,
                r = i[u.features.boxSizingProp];
            for (e.incPadding = "border-box" === r, e.callActions("beforeGetStartMixData", arguments), a = 0; o = t.show[a]; a++) n = o.getPosData(), t.showPosData[a] = {
                startPosData: n
            };
            for (a = 0; o = t.toHide[a]; a++) n = o.getPosData(), t.toHidePosData[a] = {
                startPosData: n
            };
            t.startX = s.left, t.startY = s.top, t.startHeight = e.incPadding ? s.height : s.height - parseFloat(i.paddingTop) - parseFloat(i.paddingBottom) - parseFloat(i.borderTop) - parseFloat(i.borderBottom), t.startWidth = e.incPadding ? s.width : s.width - parseFloat(i.paddingLeft) - parseFloat(i.paddingRight) - parseFloat(i.borderLeft) - parseFloat(i.borderRight), e.callActions("afterGetStartMixData", arguments)
        },
        setInter: function(t) {
            var e = this,
                i = null,
                s = -1;
            for (e.callActions("beforeSetInter", arguments), e.config.animation.clampHeight && (e.dom.parent.style.height = t.startHeight + "px", e.dom.parent.style.overflow = "hidden"), e.config.animation.clampWidth && (e.dom.parent.style.width = t.startWidth + "px", e.dom.parent.style.overflow = "hidden"), s = 0; i = t.toShow[s]; s++) i.show();
            t.willChangeLayout && (f.removeClass(e.dom.container, t.startContainerClassName), f.addClass(e.dom.container, t.newContainerClassName)), e.callActions("afterSetInter", arguments)
        },
        ...
        getFinalMixData: function(t) {
            var e, i = this,
                ...
                o = null,
                n = -1;
            for (i.callActions("beforeGetFinalMixData", arguments), n = 0; o = t.show[n]; n++) t.showPosData[n].finalPosData = o.getPosData();
            for (n = 0; o = t.toHide[n]; n++) t.toHidePosData[n].finalPosData = o.getPosData();
            for ((i.config.animation.clampHeight || i.config.animation.clampWidth) && (i.dom.parent.style.height = i.dom.parent.style.width = i.dom.parent.style.overflow = ""), i.incPadding || (s = p.getComputedStyle(i.dom.parent)), e = i.dom.parent.getBoundingClientRect(), t.newX = e.left, t.newY = e.top, t.newHeight = i.incPadding ? e.height : e.height - parseFloat(s.paddingTop) - parseFloat(s.paddingBottom) - parseFloat(s.borderTop) - parseFloat(s.borderBottom), t.newWidth = i.incPadding ? e.width : e.width - parseFloat(s.paddingLeft) - parseFloat(s.paddingRight) - parseFloat(s.borderLeft) - parseFloat(s.borderRight), t.viewportDeltaX = t.docState.viewportWidth - this.dom.document.documentElement.clientWidth, t.viewportDeltaY = t.docState.viewportHeight - this.dom.document.documentElement.clientHeight, t.willSort && i.printSort(!0, t), n = 0; o = t.toShow[n]; n++) o.hide();
            for (n = 0; o = t.toHide[n]; n++) o.show();
            t.willChangeLayout && (f.removeClass(i.dom.container, t.newContainerClassName), f.addClass(i.dom.container, i.config.layout.containerClassName)), i.callActions("afterGetFinalMixData", arguments)
        },
        getTweenData: function(t) {
            ...
            for (e.callActions("beforeGetTweenData", arguments), c = 0; i = t.show[c]; c++)
                for ((s = t.showPosData[c]).posIn = new u.StyleData, s.posOut = new u.StyleData, s.tweenData = new u.StyleData, i.isShown ? (s.posIn.x = s.startPosData.x - s.interPosData.x, s.posIn.y = s.startPosData.y - s.interPosData.y) : s.posIn.x = s.posIn.y = 0, s.posOut.x = s.finalPosData.x - s.interPosData.x, s.posOut.y = s.finalPosData.y - s.interPosData.y, s.posIn.opacity = i.isShown ? 1 : e.effectsIn.opacity, s.posOut.opacity = 1, s.tweenData.opacity = s.posOut.opacity - s.posIn.opacity, i.isShown || e.config.animation.nudge || (s.posIn.x = s.posOut.x, s.posIn.y = s.posOut.y), s.tweenData.x = s.posOut.x - s.posIn.x, s.tweenData.y = s.posOut.y - s.posIn.y, e.config.animation.animateResizeTargets && (s.posIn.width = s.startPosData.width, s.posIn.height = s.startPosData.height, r = (s.startPosData.width || s.finalPosData.width) - s.interPosData.width, s.posIn.marginRight = s.startPosData.marginRight - r, l = (s.startPosData.height || s.finalPosData.height) - s.interPosData.height, s.posIn.marginBottom = s.startPosData.marginBottom - l, s.posOut.width = s.finalPosData.width, s.posOut.height = s.finalPosData.height, r = (s.finalPosData.width || s.startPosData.width) - s.interPosData.width, s.posOut.marginRight = s.finalPosData.marginRight - r, l = (s.finalPosData.height || s.startPosData.height) - s.interPosData.height, s.posOut.marginBottom = s.finalPosData.marginBottom - l, s.tweenData.width = s.posOut.width - s.posIn.width, s.tweenData.height = s.posOut.height - s.posIn.height, s.tweenData.marginRight = s.posOut.marginRight - s.posIn.marginRight, s.tweenData.marginBottom = s.posOut.marginBottom - s.posIn.marginBottom), h = 0; n = o[h]; h++)(a = e.effectsIn[n]) instanceof u.TransformData && a.value && (s.posIn[n].value = a.value, s.posOut[n].value = 0, s.tweenData[n].value = s.posOut[n].value - s.posIn[n].value, s.posIn[n].unit = s.posOut[n].unit = s.tweenData[n].unit = a.unit);
            for (c = 0; i = t.toHide[c]; c++)
                for ((s = t.toHidePosData[c]).posIn = new u.StyleData, s.posOut = new u.StyleData, s.tweenData = new u.StyleData, s.posIn.x = i.isShown ? s.startPosData.x - s.interPosData.x : 0, s.posIn.y = i.isShown ? s.startPosData.y - s.interPosData.y : 0, s.posOut.x = e.config.animation.nudge ? 0 : s.posIn.x, s.posOut.y = e.config.animation.nudge ? 0 : s.posIn.y, s.tweenData.x = s.posOut.x - s.posIn.x, s.tweenData.y = s.posOut.y - s.posIn.y, e.config.animation.animateResizeTargets && (s.posIn.width = s.startPosData.width, s.posIn.height = s.startPosData.height, r = s.startPosData.width - s.interPosData.width, s.posIn.marginRight = s.startPosData.marginRight - r, l = s.startPosData.height - s.interPosData.height, s.posIn.marginBottom = s.startPosData.marginBottom - l), s.posIn.opacity = 1, s.posOut.opacity = e.effectsOut.opacity, s.tweenData.opacity = s.posOut.opacity - s.posIn.opacity, h = 0; n = o[h]; h++)(a = e.effectsOut[n]) instanceof u.TransformData && a.value && (s.posIn[n].value = 0, s.posOut[n].value = a.value, s.tweenData[n].value = s.posOut[n].value - s.posIn[n].value, s.posIn[n].unit = s.posOut[n].unit = s.tweenData[n].unit = a.unit);
        ...
        moveTargets: function(t) {
            ...
            for (e.callActions("beforeMoveTargets", arguments), l = 0; i = t.show[l]; l++) s = new u.IMoveData, o = t.showPosData[l], n = i.isShown ? "none" : "show", (a = e.willTransition(n, t.hasEffect, o.posIn, o.posOut)) && r++, i.show(), s.posIn = o.posIn, s.posOut = o.posOut, s.statusChange = n, s.staggerIndex = r, s.operation = t, s.callback = a ? c : null, i.move(s);
            for (l = 0; i = t.toHide[l]; l++) o = t.toHidePosData[l], s = new u.IMoveData, n = "hide", a = e.willTransition(n, o.posIn, o.posOut), s.posIn = o.posIn, s.posOut = o.posOut, s.statusChange = n, s.staggerIndex = l, s.operation = t, s.callback = a ? c : null, i.move(s);
            ...
            })), t.willChangeLayout && (f.removeClass(e.dom.container, e.config.layout.ContainerClassName), f.addClass(e.dom.container, t.newContainerClassName)), e.callActions("afterMoveTargets", arguments)
        },
        hasEffect: function() {
            ...
            for (o = 0; t = i[o]; o++)
                if (0 !== ("undefined" !== (e = this.effectsIn[t]).value ? e.value : e)) {
                    s = !0;
                    break
                } return this.callFilters("resultHasEffect", s, arguments)
        },
        willTransition: function(t, e, i, s) {
            var o = !1,
                o = !!f.isVisible(this.dom.container) && (!!("none" !== t && e || i.x !== s.x || i.y !== s.y) || !!this.config.animation.animateResizeTargets && (i.width !== s.width || i.height !== s.height || i.marginRight !== s.marginRight || i.marginTop !== s.marginTop));
            return this.callFilters("resultWillTransition", o, arguments)
        },
        ...
        cleanUp: function(t) {
            var e, i, s = this,
                ...
                n = null,
                a = -1;
            for (s.callActions("beforeCleanUp", arguments), a = s.targetsMoved = s.targetsImmovable = s.targetsBound = s.targetsDone = 0; o = t.show[a]; a++) o.cleanUp(), o.show();
            for (a = 0; o = t.toHide[a]; a++) o.cleanUp(), o.hide();
            if (t.willSort && s.printSort(!1, t), s.dom.parent.style[u.features.transitionProp] = s.dom.parent.style.height = s.dom.parent.style.width = s.dom.parent.style.overflow = s.dom.parent.style[u.features.perspectiveProp] = s.dom.parent.style[u.features.perspectiveOriginProp] = "", t.willChangeLayout && (f.removeClass(s.dom.container, t.startContainerClassName), f.addClass(s.dom.container, t.newContainerClassName)), t.toRemove.length) {
                for (a = 0; o = s.targets[a]; a++) - 1 < t.toRemove.indexOf(o) && ((e = o.dom.el.previousSibling) && "#text" === e.nodeName && (n = o.dom.el.nextSibling) && "#text" === n.nodeName && f.removeWhitespace(e), t.willSort || s.dom.parent.removeChild(o.dom.el), s.targets.splice(a, 1), o.isInDom = !1, a--);
                s.origOrder = s.targets
            }
            t.willSort && (s.targets = t.newOrder), s.state = t.newState, s.lastOperation = t, s.dom.targets = s.state.targets, u.events.fire("mixEnd", s.dom.container, {
                state: s.state,
                instance: s
            }, s.dom.document), "function" == typeof s.config.callbacks.onMixEnd && s.config.callbacks.onMixEnd.call(s.dom.container, s.state, s), t.hasFailed && (u.events.fire("mixFail", s.dom.container, {
                state: s.state,
                instance: s
            }, s.dom.document), "function" == typeof s.config.callbacks.onMixFail && s.config.callbacks.onMixFail.call(s.dom.container, s.state, s), f.addClass(s.dom.container, f.getClassname(s.config.classNames, "container", s.config.classNames.modifierFailed))), "function" == typeof s.userCallback && s.userCallback.call(s.dom.container, s.state, s), "function" == typeof s.userDeferred.resolve && s.userDeferred.resolve(s.state), s.userCallback = null, s.userDeferred = null, s.lastClicked = null, s.isToggling = !1, s.isBusy = !1, s.queue.length && (s.callActions("beforeReadQueueCleanUp", arguments), i = s.queue.shift(), s.userDeferred = i.deferred, s.isToggling = i.isToggling, s.lastClicked = i.triggerElement, i.instruction.command instanceof u.CommandMultimix ? s.multimix.apply(s, i.args) : s.dataset.apply(s, i.args)), s.callActions("afterCleanUp", arguments)
        },
        parseMultimixArgs: function(t) {
            var e, i = this,
                s = new u.UserInstruction,
                o = -1;
            for (s.animate = i.config.animation.enable, s.command = new u.CommandMultimix, o = 0; o < t.length; o++) null !== (e = t[o]) && ("object" == typeof e ? f.extend(s.command, e) : "boolean" == typeof e ? s.animate = e : "function" == typeof e && (s.callback = e));
            return !s.command.insert || s.command.insert instanceof u.CommandInsert || (s.command.insert = i.parseInsertArgs([s.command.insert]).command), !s.command.remove || s.command.remove instanceof u.CommandRemove || (s.command.remove = i.parseRemoveArgs([s.command.remove]).command), !s.command.filter || s.command.filter instanceof u.CommandFilter || (s.command.filter = i.parseFilterArgs([s.command.filter]).command), !s.command.sort || s.command.sort instanceof u.CommandSort || (s.command.sort = i.parseSortArgs([s.command.sort]).command), !s.command.changeLayout || s.command.changeLayout instanceof u.CommandChangeLayout || (s.command.changeLayout = i.parseChangeLayoutArgs([s.command.changeLayout]).command), s = i.callFilters("instructionParseMultimixArgs", s, arguments), f.freeze(s), s
        },
        parseFilterArgs: function(t) {
            var e, i = new u.UserInstruction,
                s = -1;
            for (i.animate = this.config.animation.enable, i.command = new u.CommandFilter, s = 0; s < t.length; s++) "string" == typeof(e = t[s]) ? i.command.selector = e : null === e ? i.command.collection = [] : "object" == typeof e && f.isElement(e, this.dom.document) ? i.command.collection = [e] : "object" == typeof e && void 0 !== e.length ? i.command.collection = f.arrayFromList(e) : "object" == typeof e ? f.extend(i.command, e) : "boolean" == typeof e ? i.animate = e : "function" == typeof e && (i.callback = e);
            if (i.command.selector && i.command.collection) throw new Error(u.messages.errorFilterInvalidArguments());
            return i = this.callFilters("instructionParseFilterArgs", i, arguments), f.freeze(i), i
        },
        parseSortArgs: function(t) {
            var e, i = new u.UserInstruction,
                s = "",
                o = -1;
            for (i.animate = this.config.animation.enable, i.command = new u.CommandSort, o = 0; o < t.length; o++)
                if (null !== (e = t[o])) switch (typeof e) {
                    case "string":
                        s = e;
                        break;
                    case "object":
                        e.length && (i.command.collection = f.arrayFromList(e));
                        break;
                    case "boolean":
                        i.animate = e;
                        break;
            ...
            return s && (i.command = this.parseSortString(s, i.command)), i = this.callFilters("instructionParseSortArgs", i, arguments), f.freeze(i), i
        },
        parseInsertArgs: function(t) {
            var e, i = new u.UserInstruction,
                s = -1;
            for (i.animate = this.config.animation.enable, i.command = new u.CommandInsert, s = 0; s < t.length; s++) null !== (e = t[s]) && ("number" == typeof e ? i.command.index = e : "string" == typeof e && -1 < ["before", "after"].indexOf(e) ? i.command.position = e : "string" == typeof e ? i.command.collection = f.arrayFromList(f.createElement(e).childNodes) : "object" == typeof e && f.isElement(e, this.dom.document) ? i.command.collection.length ? i.command.sibling = e : i.command.collection = [e] : "object" == typeof e && e.length ? i.command.collection.length ? i.command.sibling = e[0] : i.command.collection = e : "object" == typeof e && e.childNodes && e.childNodes.length ? i.command.collection.length ? i.command.sibling = e.childNodes[0] : i.command.collection = f.arrayFromList(e.childNodes) : "object" == typeof e ? f.extend(i.command, e) : "boolean" == typeof e ? i.animate = e : "function" == typeof e && (i.callback = e));
            if (i.command.index && i.command.sibling) throw new Error(u.messages.errorInsertInvalidArguments());
            return !i.command.collection.length && this.config.debug.showWarnings && console.warn(u.messages.warningInsertNoElements()), i = this.callFilters("instructionParseInsertArgs", i, arguments), f.freeze(i), i
        },
        parseRemoveArgs: function(t) {
            var e, i, s = this,
                o = new u.UserInstruction,
                n = -1;
            for (o.animate = s.config.animation.enable, o.command = new u.CommandRemove, n = 0; n < t.length; n++)
                if (null !== (i = t[n])) switch (typeof i) {
                    case "number":
                        s.targets[i] && (o.command.targets[0] = s.targets[i]);
                        break;
                    case "string":
                        o.command.collection = f.arrayFromList(s.dom.parent.querySelectorAll(i));
                        break;
                    case "object":
                        i && i.length ? o.command.collection = i : f.isElement(i, s.dom.document) ? o.command.collection = [i] : f.extend(o.command, i);
                        break;
                    case "boolean":
                        o.animate = i;
                        break;
            ...
            if (o.command.collection.length)
                for (n = 0; e = s.targets[n]; n++) - 1 < o.command.collection.indexOf(e.dom.el) && o.command.targets.push(e);
            return !o.command.targets.length && s.config.debug.showWarnings && console.warn(u.messages.warningRemoveNoElements()), f.freeze(o), o
        },
        parseDatasetArgs: function(t) {
            var e, i = new u.UserInstruction,
                s = -1;
            for (i.animate = this.config.animation.enable, i.command = new u.CommandDataset, s = 0; s < t.length; s++)
                if (null !== (e = t[s])) switch (typeof e) {
                    case "object":
                        Array.isArray(e) || "number" == typeof e.length ? i.command.dataset = e : f.extend(i.command, e);
                        break;
                    case "boolean":
                        i.animate = e;
                        break;
        ...
        parseChangeLayoutArgs: function(t) {
            var e, i = new u.UserInstruction,
                s = -1;
            for (i.animate = this.config.animation.enable, i.command = new u.CommandChangeLayout, s = 0; s < t.length; s++)
                if (null !== (e = t[s])) switch (typeof e) {
                    case "string":
                        i.command.containerClassName = e;
                        break;
                    case "object":
                        f.extend(i.command, e);
                        break;
                    case "boolean":
                        i.animate = e;
                        break;
        ...
        queueMix: function(t) {
            var e, i = this,
                s = null;
            return i.callActions("beforeQueueMix", arguments), s = f.defer(u.libraries), i.config.animation.queue && i.queue.length < i.config.animation.queueLimit ? (t.deferred = s, i.queue.push(t), i.config.controls.enable && (i.isToggling ? (i.buildToggleArray(t.instruction.command), e = i.getToggleSelector(), i.updateControls({
                filter: {
                    selector: e
                }
            })) : i.updateControls(t.instruction.command))) : (i.config.debug.showWarnings && console.warn(u.messages.warningMultimixInstanceQueueFull()), s.resolve(i.state), u.events.fire("mixBusy", i.dom.container, {
                state: i.state,
                instance: i
            }, i.dom.document), "function" == typeof i.config.callbacks.onMixBusy && i.config.callbacks.onMixBusy.call(i.dom.container, i.state, i)), i.callFilters("promiseQueueMix", s.promise, arguments)
        },
        getDataOperation: function(t) {
            ...
            if (e.dom.targets.length && !(s = e.state.activeDataset || []).length) throw new Error(u.messages.errorDatasetNotSet());
            return i.id = f.randomHex(), i.startState = e.state, i.startDataset = s, i.newDataset = t.slice(), e.diffDatasets(i), i.startOrder = e.targets, i.newOrder = i.show, e.config.animation.enable && (e.getStartMixData(i), e.setInter(i), i.docState = f.getDocumentState(e.dom.document), e.getInterMixData(i), e.setFinal(i), e.getFinalMixData(i), e.parseEffects(), i.hasEffect = e.hasEffect(), e.getTweenData(i)), e.targets = i.show.slice(), i.newState = e.buildState(i), Array.prototype.push.apply(e.targets, i.toRemove), i = e.callFilters("operationMappedGetDataOperation", i, arguments)
        },
        diffDatasets: function(t) {
            ...
            for (e.callActions("beforeDiffDatasets", arguments), p = 0; n = t.newDataset[p]; p++) {
                if (void 0 === (d = n[e.config.data.uidKey]) || d.toString().length < 1) throw new TypeError(u.messages.errorDatasetInvalidUidKey({
                    uidKey: e.config.data.uidKey
                }));
                if (h[d]) throw new Error(u.messages.errorDatasetDuplicateUid({
                    uid: d
                }));
                h[d] = !0, (a = e.cache[d]) instanceof u.Target ? (e.config.data.dirtyCheck && !f.deepEquals(n, a.data) && (r = a.render(n), a.data = n, r !== a.dom.el && (a.isInDom && (a.unbindEvents(), e.dom.parent.replaceChild(r, a.dom.el)), a.isShown || (r.style.display = "none"), a.dom.el = r, a.isInDom && a.bindEvents())), r = a.dom.el) : ((a = new u.Target).init(null, e, n), a.hide()), a.isInDom ? (c = a.dom.el.nextElementSibling, s.push(d), l && (l.lastElementChild && l.appendChild(e.dom.document.createTextNode(" ")), e.insertDatasetFrag(l, a.dom.el, o), l = null)) : ((l = l || e.dom.document.createDocumentFragment()).lastElementChild && l.appendChild(e.dom.document.createTextNode(" ")), l.appendChild(a.dom.el), a.isInDom = !0, a.unbindEvents(), a.bindEvents(), a.hide(), t.toShow.push(a), o.push(a)), t.show.push(a)
            }
            for (l && ((c = c || e.config.layout.siblingAfter) && l.appendChild(e.dom.document.createTextNode(" ")), e.insertDatasetFrag(l, c, o)), p = 0; n = t.startDataset[p]; p++) d = n[e.config.data.uidKey], a = e.cache[d], t.show.indexOf(a) < 0 ? (t.hide.push(a), t.toHide.push(a), t.toRemove.push(a)) : i.push(d);
            f.isEqualArray(i, s) || (t.willSort = !0), e.callActions("afterDiffDatasets", arguments)
        },
        insertDatasetFrag: function(t, e, i) {
            var s = e ? f.arrayFromList(this.dom.parent.children).indexOf(e) : this.targets.length;
            for (this.dom.parent.insertBefore(t, e); i.length;) this.targets.splice(s, 0, i.shift()), s++
        },
        ...
        toggleOn: function() {
            var t, e = this,
                ...
                s = i.command.selector;
            return e.isToggling = !0, e.toggleArray.indexOf(s) < 0 && e.toggleArray.push(s), t = e.getToggleSelector(), e.multimix({
                filter: t
        ...
        toggleOff: function() {
            var t, e = this,
                i = e.parseFilterArgs(arguments),
                s = i.command.selector,
                o = e.toggleArray.indexOf(s);
            return e.isToggling = !0, -1 < o && e.toggleArray.splice(o, 1), t = e.getToggleSelector(), e.multimix({
                filter: t
            }, i.animate, i.callback)
        },
        sort: function() {
        ...
        dataset: function() {
            var t, e, i = this,
                s = i.parseDatasetArgs(arguments),
                o = null;
            return i.callActions("beforeDataset", arguments), i.isBusy ? ((o = new u.QueueItem).args = arguments, o.instruction = s, i.queueMix(o)) : (s.callback && (i.userCallback = s.callback), e = s.animate ^ i.config.animation.enable ? s.animate : i.config.animation.enable, t = i.getDataOperation(s.command.dataset), i.goMix(e, t))
        },
        multimix: function() {
            var t, e, i = this,
                s = null,
                o = i.parseMultimixArgs(arguments);
        ...
        getOperation: function(t) {
            var e = this,
                ...
                a = t.insert,
                r = new u.Operation;
            return (r = e.callFilters("operationUnmappedGetOperation", r, arguments)).id = f.randomHex(), r.command = t, r.startState = e.state, r.triggerElement = e.lastClicked, e.isBusy ? (e.config.debug.showWarnings && console.warn(u.messages.warningGetOperationInstanceBusy()), null) : (a && e.insertTargets(a, r), n && (r.toRemove = n.targets), r.startSort = r.newSort = r.startState.activeSort, r.startOrder = r.newOrder = e.targets, i && (r.startSort = r.startState.activeSort, r.newSort = i, r.willSort = e.willSort(i, r.startState.activeSort), r.willSort && e.sortOperation(r)), r.startFilter = r.startState.activeFilter, r.newFilter = s || f.extend(new u.CommandFilter, r.startFilter), "all" === r.newFilter.selector ? r.newFilter.selector = e.config.selectors.target : "none" === r.newFilter.selector && (r.newFilter.selector = ""), e.filterOperation(r), r.startContainerClassName = r.startState.activeContainerClassName, o ? (r.newContainerClassName = o.containerClassName, r.newContainerClassName !== r.startContainerClassName && (r.willChangeLayout = !0)) : r.newContainerClassName = r.startContainerClassName, e.config.animation.enable && (e.getStartMixData(r), e.setInter(r), r.docState = f.getDocumentState(e.dom.document), e.getInterMixData(r), e.setFinal(r), e.getFinalMixData(r), e.parseEffects(), r.hasEffect = e.hasEffect(), e.getTweenData(r)), r.willSort && (e.targets = r.newOrder), r.newState = e.buildState(r), e.callFilters("operationMappedGetOperation", r, arguments))
        },
        tween: function(t, e) {
            var i, s = null,
                o = null,
                n = -1;
            for (e = Math.min(e, 1), e = Math.max(e, 0), n = 0; s = t.show[n]; n++) o = t.showPosData[n], s.applyTween(o, e);
            for (n = 0; s = t.hide[n]; n++) s.isShown && s.hide(), -1 < (i = t.toHide.indexOf(s)) && (o = t.toHidePosData[i], s.isShown || s.show(), s.applyTween(o, e))
        },
        insert: function() {
        ...
        getConfig: function(t) {
            var e = null,
                e = t ? f.getProperty(this.config, t) : this.config;
            return this.callFilters("valueGetConfig", e, arguments)
        },
        configure: function(t) {
            this.callActions("beforeConfigure", arguments), f.extend(this.config, t, !0, !0), this.callActions("afterConfigure", arguments)
        },
        getState: function() {
            var t = new u.State;
            return f.extend(t, this.state), f.freeze(t), this.callFilters("stateGetState", t, arguments)
        },
        ...
        forceRender: function() {
            var t = this,
                ...
                i = null,
                s = "";
            for (s in t.cache)(i = (e = t.cache[s]).render(e.data)) !== e.dom.el && (e.isInDom && (e.unbindEvents(), t.dom.parent.replaceChild(i, e.dom.el)), e.isShown || (i.style.display = "none"), e.dom.el = i, e.isInDom && e.bindEvents());
        ...
        destroy: function(t) {
            var e = this,
                ...
                s = null,
                o = 0;
            for (e.callActions("beforeDestroy", arguments), o = 0; i = e.controls[o]; o++) i.removeBinding(e);
            for (o = 0; s = e.targets[o]; o++) t && s.show(), s.unbindEvents();
            e.dom.container.id.match(/^MixItUp/) && e.dom.container.removeAttribute("id"), delete u.instances[e.id], e.callActions("afterDestroy", arguments)
        }
    }), u.IMoveData = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.posIn = null, this.posOut = null, this.operation = null, this.callback = null, this.statusChange = "", this.duration = -1, this.staggerIndex = -1, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.IMoveData), u.IMoveData.prototype = Object.create(u.Base.prototype), u.IMoveData.prototype.constructor = u.IMoveData, u.TargetDom = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.el = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.TargetDom), u.TargetDom.prototype = Object.create(u.Base.prototype), u.TargetDom.prototype.constructor = u.TargetDom, u.Target = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.id = "", this.sortString = "", this.mixer = null, this.callback = null, this.isShown = !1, this.isBound = !1, this.isExcluded = !1, this.isInDom = !1, this.handler = null, this.operation = null, this.data = null, this.dom = new u.TargetDom, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Target), u.Target.prototype = Object.create(u.Base.prototype), f.extend(u.Target.prototype, {
        constructor: u.Target,
        init: function(t, e, i) {
            var s = this,
                o = "";
            if (s.callActions("beforeInit", arguments), s.mixer = e, t = t || s.render(i), s.cacheDom(t), s.bindEvents(), "none" !== s.dom.el.style.display && (s.isShown = !0), i && e.config.data.uidKey) {
                if (void 0 === (o = i[e.config.data.uidKey]) || o.toString().length < 1) throw new TypeError(u.messages.errorDatasetInvalidUidKey({
                    uidKey: e.config.data.uidKey
                }));
                s.id = o, s.data = i, e.cache[o] = s
            }
        ...
        render: function(t) {
            ...
            return (e = i(t)) && "object" == typeof e && f.isElement(e) ? s = e : "string" == typeof e && ((o = document.createElement("div")).innerHTML = e, s = o.firstElementChild), this.callFilters("elRender", s, arguments)
        },
        cacheDom: function(t) {
        ...
        getSortString: function(t) {
            ...
            this.callActions("beforeGetSortString", arguments), e = isNaN(+e) ? e.toLowerCase() : +e, this.sortString = e, this.callActions("afterGetSortString", arguments)
        },
        show: function() {
            var t = this;
        ...
        applyTween: function(t, e) {
            var i, s, o = this,
                ...
                r = new u.StyleData,
                l = -1;
            for (o.callActions("beforeApplyTween", arguments), r.x = n.x, r.y = n.y, 0 === e ? o.hide() : o.isShown || o.show(), l = 0; i = u.features.TWEENABLE[l]; l++)
                if (s = t.tweenData[i], "x" === i) {
                    if (!s) continue;
                    r.x = n.x + s * e
                } else if ("y" === i) {
                if (!s) continue;
                ...
                if (!s.value) continue;
                r[i].value = n[i].value + s.value * e, r[i].unit = s.unit, a.push(i + "(" + r[i].value + s.unit + ")")
            } else {
                if (!s) continue;
                r[i] = n[i] + s * e, o.dom.el.style[i] = r[i]
            }(r.x || r.y) && a.unshift("translate(" + r.x + "px, " + r.y + "px)"), a.length && (o.dom.el.style[u.features.transformProp] = a.join(" ")), o.callActions("afterApplyTween", arguments)
        },
        applyStylesIn: function(t) {
            var e = this,
                i = t.posIn,
                s = 1 !== e.mixer.effectsIn.opacity,
                o = [];
            e.callActions("beforeApplyStylesIn", arguments), o.push("translate(" + i.x + "px, " + i.y + "px)"), e.mixer.config.animation.animateResizeTargets && ("show" !== t.statusChange && (e.dom.el.style.width = i.width + "px", e.dom.el.style.height = i.height + "px"), e.dom.el.style.marginRight = i.marginRight + "px", e.dom.el.style.marginBottom = i.marginBottom + "px"), s && (e.dom.el.style.opacity = i.opacity), "show" === t.statusChange && (o = o.concat(e.mixer.transformIn)), e.dom.el.style[u.features.transformProp] = o.join(" "), e.callActions("afterApplyStylesIn", arguments)
        },
        applyStylesOut: function(t) {
            ...
            switch (e.operation = t.operation, e.callback = t.callback, e.isExcluded || e.mixer.targetsBound++, e.isBound = !0, e.applyTransition(i), o && 0 < t.posOut.width && 0 < t.posOut.height && (e.dom.el.style.width = t.posOut.width + "px", e.dom.el.style.height = t.posOut.height + "px", e.dom.el.style.marginRight = t.posOut.marginRight + "px", e.dom.el.style.marginBottom = t.posOut.marginBottom + "px"), e.mixer.config.animation.nudge || "hide" !== t.statusChange || s.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"), t.statusChange) {
                case "hide":
                    n && (e.dom.el.style.opacity = e.mixer.effectsOut.opacity), s = s.concat(e.mixer.transformOut);
                    break;
                case "show":
                    n && (e.dom.el.style.opacity = 1)
            }(e.mixer.config.animation.nudge || !e.mixer.config.animation.nudge && "hide" !== t.statusChange) && s.push("translate(" + t.posOut.x + "px, " + t.posOut.y + "px)"), e.dom.el.style[u.features.transformProp] = s.join(" "), e.callActions("afterApplyStylesOut", arguments)
        },
        writeTransitionRule: function(t, e, i) {
            var s = this.getDelay(e),
                o = t + " " + (0 < i ? i : this.mixer.config.animation.duration) + "ms " + s + "ms " + ("opacity" === t ? "linear" : this.mixer.config.animation.easing);
            return this.callFilters("ruleWriteTransitionRule", o, arguments)
        },
        getDelay: function(t) {
            var e, i = this;
        ...
        applyTransition: function(t) {
            var e = t.join(", ");
            this.callActions("beforeApplyTransition", arguments), this.dom.el.style[u.features.transitionProp] = e, this.callActions("afterApplyTransition", arguments)
        },
        handleTransitionEnd: function(t) {
            var e = this,
                i = t.propertyName,
                s = e.mixer.config.animation.animateResizeTargets;
            e.callActions("beforeHandleTransitionEnd", arguments), e.isBound && t.target.matches(e.mixer.config.selectors.target) && (-1 < i.indexOf("transform") || -1 < i.indexOf("opacity") || s && -1 < i.indexOf("height") || s && -1 < i.indexOf("width") || s && -1 < i.indexOf("margin")) && (e.callback.call(e, e.operation), e.isBound = !1, e.callback = null, e.operation = null), e.callActions("afterHandleTransitionEnd", arguments)
        },
        eventBus: function(t) {
        ...
        unbindEvents: function() {
            var t = this;
            t.callActions("beforeUnbindEvents", arguments), f.off(t.dom.el, "webkitTransitionEnd", t.handler), f.off(t.dom.el, "transitionend", t.handler), t.callActions("afterUnbindEvents", arguments)
        },
        bindEvents: function() {
            var t, e = this;
            e.callActions("beforeBindEvents", arguments), t = "webkit" === u.features.transitionPrefix ? "webkitTransitionEnd" : "transitionend", e.handler = function(t) {
                return e.eventBus(t)
            }, f.on(e.dom.el, t, e.handler), e.callActions("afterBindEvents", arguments)
        },
        getPosData: function(t) {
            var e, i, s = this,
                o = new u.StyleData;
            return s.callActions("beforeGetPosData", arguments), o.x = s.dom.el.offsetLeft, o.y = s.dom.el.offsetTop, (s.mixer.config.animation.animateResizeTargets || t) && (i = s.dom.el.getBoundingClientRect(), o.top = i.top, o.right = i.right, o.bottom = i.bottom, o.left = i.left, o.width = i.width, o.height = i.height), s.mixer.config.animation.animateResizeTargets && (e = p.getComputedStyle(s.dom.el), o.marginBottom = parseFloat(e.marginBottom), o.marginRight = parseFloat(e.marginRight)), s.callFilters("posDataGetPosData", o, arguments)
        },
        cleanUp: function() {
            var t = this;
            t.callActions("beforeCleanUp", arguments), t.dom.el.style[u.features.transformProp] = "", t.dom.el.style[u.features.transitionProp] = "", t.dom.el.style.opacity = "", t.mixer.config.animation.animateResizeTargets && (t.dom.el.style.width = "", t.dom.el.style.height = "", t.dom.el.style.marginRight = "", t.dom.el.style.marginBottom = ""), t.callActions("afterCleanUp", arguments)
        }
    }), u.Collection = function(t) {
        var e, i = -1;
        for (this.callActions("beforeConstruct"), i = 0; e = t[i]; i++) this[i] = e;
        this.length = t.length, this.callActions("afterConstruct"), f.freeze(this)
    }, u.BaseStatic.call(u.Collection), u.Collection.prototype = Object.create(u.Base.prototype), f.extend(u.Collection.prototype, {
        ...
        mixitup: function(t) {
            var e = null,
                ...
                s = [],
                o = -1;
            for (this.callActions("beforeMixitup"), i.shift(), o = 0; e = this[o]; o++) s.push(e[t].apply(e, i));
            return this.callFilters("promiseMixitup", f.all(s, u.libraries), arguments)
        }
    }), u.Operation = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.id = "", this.args = [], this.command = null, this.showPosData = [], this.toHidePosData = [], this.startState = null, this.newState = null, this.docState = null, this.willSort = !1, this.willChangeLayout = !1, this.hasEffect = !1, this.hasFailed = !1, this.triggerElement = null, this.show = [], this.hide = [], this.matching = [], this.toShow = [], this.toHide = [], this.toMove = [], this.toRemove = [], this.startOrder = [], this.newOrder = [], this.startSort = null, this.newSort = null, this.startFilter = null, this.newFilter = null, this.startDataset = null, this.newDataset = null, this.viewportDeltaX = 0, this.viewportDeltaY = 0, this.startX = 0, this.startY = 0, this.startHeight = 0, this.startWidth = 0, this.newX = 0, this.newY = 0, this.newHeight = 0, this.newWidth = 0, this.startContainerClassName = "", this.startDisplay = "", this.newContainerClassName = "", this.newDisplay = "", this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.Operation), u.Operation.prototype = Object.create(u.Base.prototype), u.Operation.prototype.constructor = u.Operation, u.State = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.id = "", this.activeFilter = null, this.activeSort = null, this.activeContainerClassName = "", this.container = null, this.targets = [], this.hide = [], this.show = [], this.matching = [], this.totalTargets = -1, this.totalShow = -1, this.totalHide = -1, this.totalMatching = -1, this.hasFailed = !1, this.triggerElement = null, this.activeDataset = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.State), u.State.prototype = Object.create(u.Base.prototype), u.State.prototype.constructor = u.State, u.UserInstruction = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.command = {}, this.animate = !1, this.callback = null, this.callActions("afterConstruct"), f.seal(this)
    }, u.BaseStatic.call(u.UserInstruction), u.UserInstruction.prototype = Object.create(u.Base.prototype), u.UserInstruction.prototype.constructor = u.UserInstruction, u.Messages = function() {
        u.Base.call(this), this.callActions("beforeConstruct"), this.ERROR_FACTORY_INVALID_CONTAINER = "[MixItUp] An invalid selector or element reference was passed to the mixitup factory function", this.ERROR_FACTORY_CONTAINER_NOT_FOUND = "[MixItUp] The provided selector yielded no container element", this.ERROR_CONFIG_INVALID_ANIMATION_EFFECTS = "[MixItUp] Invalid value for `animation.effects`", this.ERROR_CONFIG_INVALID_CONTROLS_SCOPE = "[MixItUp] Invalid value for `controls.scope`", this.ERROR_CONFIG_INVALID_PROPERTY = '[MixitUp] Invalid configuration object property "${erroneous}"${suggestion}', this.ERROR_CONFIG_INVALID_PROPERTY_SUGGESTION = '. Did you mean "${probableMatch}"?', this.ERROR_CONFIG_DATA_UID_KEY_NOT_SET = "[MixItUp] To use the dataset API, a UID key must be specified using `data.uidKey`", this.ERROR_DATASET_INVALID_UID_KEY = '[MixItUp] The specified UID key "${uidKey}" is not present on one or more dataset items', this.ERROR_DATASET_DUPLICATE_UID = '[MixItUp] The UID "${uid}" was found on two or more dataset items. UIDs must be unique.', this.ERROR_INSERT_INVALID_ARGUMENTS = "[MixItUp] Please provider either an index or a sibling and position to insert, not both", this.ERROR_INSERT_PREEXISTING_ELEMENT = "[MixItUp] An element to be inserted already exists in the container", this.ERROR_FILTER_INVALID_ARGUMENTS = "[MixItUp] Please provide either a selector or collection `.filter()`, not both", this.ERROR_DATASET_NOT_SET = "[MixItUp] To use the dataset API with pre-rendered targets, a starting dataset must be set using `load.dataset`", this.ERROR_DATASET_PRERENDERED_MISMATCH = "[MixItUp] `load.dataset` does not match pre-rendered targets", this.ERROR_DATASET_RENDERER_NOT_SET = "[MixItUp] To insert an element via the dataset API, a target renderer function must be provided to `render.target`", this.ERROR_SORT_NON_EXISTENT_ELEMENT = "[MixItUp] An element to be sorted does not already exist in the container", this.WARNING_FACTORY_PREEXISTING_INSTANCE = "[MixItUp] WARNING: This element already has an active MixItUp instance. The provided configuration object will be ignored. If you wish to perform additional methods on this instance, please create a reference.", this.WARNING_INSERT_NO_ELEMENTS = "[MixItUp] WARNING: No valid elements were passed to `.insert()`", this.WARNING_REMOVE_NO_ELEMENTS = "[MixItUp] WARNING: No valid elements were passed to `.remove()`", this.WARNING_MULTIMIX_INSTANCE_QUEUE_FULL = "[MixItUp] WARNING: An operation was requested but the MixItUp instance was busy. The operation was rejected because the queue is full or queuing is disabled.", this.WARNING_GET_OPERATION_INSTANCE_BUSY = "[MixItUp] WARNING: Operations can be be created while the MixItUp instance is busy.", this.WARNING_NO_PROMISE_IMPLEMENTATION = "[MixItUp] WARNING: No Promise implementations could be found. If you wish to use promises with MixItUp please install an ES6 Promise polyfill.", this.WARNING_INCONSISTENT_SORTING_ATTRIBUTES = '[MixItUp] WARNING: The requested sorting data attribute "${attribute}" was not present on one or more target elements which may product unexpected sort output', this.callActions("afterConstruct"), this.compileTemplates(), f.seal(this)
    }, u.BaseStatic.call(u.Messages), u.Messages.prototype = Object.create(u.Base.prototype), u.Messages.prototype.constructor = u.Messages, u.Messages.prototype.compileTemplates = function() {
        var t, e = "";
        for (e in this) "string" == typeof(t = this[e]) && (this[f.camelCase(e)] = f.template(t))
    }, u.messages = new u.Messages, u.Facade = function(t) {
        u.Base.call(this), this.callActions("beforeConstruct", arguments), this.configure = t.configure.bind(t), this.show = t.show.bind(t), this.hide = t.hide.bind(t), this.filter = t.filter.bind(t), this.toggleOn = t.toggleOn.bind(t), this.toggleOff = t.toggleOff.bind(t), this.sort = t.sort.bind(t), this.changeLayout = t.changeLayout.bind(t), this.multimix = t.multimix.bind(t), this.dataset = t.dataset.bind(t), this.tween = t.tween.bind(t), this.insert = t.insert.bind(t), this.insertBefore = t.insertBefore.bind(t), this.insertAfter = t.insertAfter.bind(t), this.prepend = t.prepend.bind(t), this.append = t.append.bind(t), this.remove = t.remove.bind(t), this.destroy = t.destroy.bind(t), this.forceRefresh = t.forceRefresh.bind(t), this.forceRender = t.forceRender.bind(t), this.isMixing = t.isMixing.bind(t), this.getOperation = t.getOperation.bind(t), this.getConfig = t.getConfig.bind(t), this.getState = t.getState.bind(t), this.callActions("afterConstruct", arguments), f.freeze(this), f.seal(this)
    }, u.BaseStatic.call(u.Facade), u.Facade.prototype = Object.create(u.Base.prototype), u.Facade.prototype.constructor = u.Facade, "object" == typeof exports && "object" == typeof module ? module.exports = u : "function" == typeof define && define.amd ? define(function() {
        return u
    }) : void 0 !== p.mixitup && "function" == typeof p.mixitup || (p.mixitup = u), u.BaseStatic.call(u.constructor), u.NAME = "mixitup", u.CORE_VERSION = "3.3.1"
}(window),
function(e) {
    ...
    "use strict";
    var e, i, s = 0,
        o = (e = t.userAgent, i = /msie\s\d+/i, 0 < e.search(i) && i.exec(e).toString().split(" ")[1] < 9 && (l("html").addClass("lt-ie9"), !0));
    ...
    n.prototype = {
            ...
            drawLabels: function() {
                ...
                this.options && (t = this.options.values.length, e = this.options.p_values, this.options.hide_from_to || ("single" === this.options.type ? (i = t ? this.decorate(e[this.result.from]) : (n = this._prettify(this.result.from), this.decorate(n, this.result.from)), this.$cache.single.html(i), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible") : (o = t ? (this.options.decorate_both ? (i = this.decorate(e[this.result.from]), i += this.options.values_separator, i += this.decorate(e[this.result.to])) : i = this.decorate(e[this.result.from] + this.options.values_separator + e[this.result.to]), s = this.decorate(e[this.result.from]), this.decorate(e[this.result.to])) : (n = this._prettify(this.result.from), a = this._prettify(this.result.to), this.options.decorate_both ? (i = this.decorate(n, this.result.from), i += this.options.values_separator, i += this.decorate(a, this.result.to)) : i = this.decorate(n + this.options.values_separator + a, this.result.to), s = this.decorate(n, this.result.from), this.decorate(a, this.result.to)), this.$cache.single.html(i), this.$cache.from.html(s), this.$cache.to.html(o), this.calcLabels(), r = Math.min(this.labels.p_single_left, this.labels.p_from_left), l = this.labels.p_single_left + this.labels.p_single_fake, c = this.labels.p_to_left + this.labels.p_to_fake, h = Math.max(l, c), this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", h = this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"), this.$cache.single[0].style.visibility = "hidden", c) : (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", Math.max(l, c))) : (this.$cache.from[0].style.visibility = "visible", this.$cache.to[0].style.visibility = "visible", this.$cache.single[0].style.visibility = "hidden"), r < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", h > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible")))
            },
            drawShadow: function() {
